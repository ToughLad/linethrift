.class public final Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl$a;->b:Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `friend_safety_status` (`disaster_id` TEXT NOT NULL, `contact_mid` TEXT NOT NULL, `status` INTEGER NOT NULL, `message` TEXT, `update_time` INTEGER NOT NULL, PRIMARY KEY(`disaster_id`, `contact_mid`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS `disaster_info` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `region` TEXT NOT NULL, `description` TEXT NOT NULL, `url` TEXT NOT NULL, `message_template` TEXT NOT NULL, `status` INTEGER NOT NULL, `is_high_impact` INTEGER NOT NULL, PRIMARY KEY(`id`))"

    const-string v1, "CREATE INDEX IF NOT EXISTS `index_disaster_info_region` ON `disaster_info` (`region`)"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'c6bed7d14481b1cdfdcde36317747a52\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `friend_safety_status`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "DROP TABLE IF EXISTS `disaster_info`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;->q:I

    iget-object p0, p0, Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl$a;->b:Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;->q:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl$a;->b:Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;

    sget v1, Lcom/linecorp/home/safetycheck/db/SafetyCheckDatabase_Impl;->q:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    invoke-static {v1, v3, v7, v4}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v7, "friend_safety_status"
    ...
    const-string v2, "friend_safety_status(com.linecorp.home.safetycheck.db.FriendSafetyStatusEntity).\n Expected:\n"
    ...
    const-string v14, "message_template"
    ...
    const-string v16, "is_high_impact"
    ...
    const-string v2, "is_high_impact"

    invoke-static {v1, v2, v13, v4}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v10, "index_disaster_info_region"

    invoke-direct {v8, v10, v4, v3, v9}, Lk5/d$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V

    invoke-virtual {v6, v8}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    new-instance v3, Lk5/d;

    const-string v8, "disaster_info"

    invoke-direct {v3, v8, v1, v2, v6}, Lk5/d;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V

    invoke-static {v0, v8}, Lk5/d;->a(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Lk5/d;

    move-result-object v0

    invoke-virtual {v3, v0}, Lk5/d;->equals(Ljava/lang/Object;)Z
    ...
    const-string v2, "disaster_info(com.linecorp.home.safetycheck.db.DisasterInfoEntity).\n Expected:\n"

    invoke-static {v2, v3, v5, v0}, LQ5/N;->a(Ljava/lang/String;Lk5/d;Ljava/lang/String;Lk5/d;)Ljava/lang/String;

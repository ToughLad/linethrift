...
# direct methods
.method public constructor <init>(Lcom/linecorp/line/album/ui/photoviewer/PhotoViewerFragment;Lzm/B;Lzm/z1;LDl/n;Landroid/view/View;LUk/g;LBl/a;ZLUk/x;Landroidx/fragment/app/n;)V
    .locals 1
    ...
    iput-object p1, p0, Lqm/b;->a:Lcom/linecorp/line/album/ui/photoviewer/PhotoViewerFragment;

    iput-object p3, p0, Lqm/b;->b:Lzm/z1;

    iput-object p4, p0, Lqm/b;->c:LDl/n;

    iput-object p5, p0, Lqm/b;->d:Landroid/view/View;

    iput-object p6, p0, Lqm/b;->e:LUk/g;

    iput-object p7, p0, Lqm/b;->f:LBl/a;

    iput-object p9, p0, Lqm/b;->g:LUk/x;

    iput-object p10, p0, Lqm/b;->h:Landroidx/fragment/app/n;
    ...
    iput-object p6, p0, Lqm/b;->i:Lkotlin/Lazy;
    ...
    iput-object p7, p0, Lqm/b;->j:Lkotlin/Lazy;
    ...
    iput-object p9, p0, Lqm/b;->k:Lkotlin/Lazy;
    ...
    iput-object p9, p0, Lqm/b;->l:Lkotlin/Lazy;
    ...
    iput-object p9, p0, Lqm/b;->m:Lkotlin/Lazy;
    ...
    iput-object p9, p0, Lqm/b;->n:Lkotlin/Lazy;
    ...
    iput-object p5, p0, Lqm/b;->o:Lkotlin/Lazy;
    ...
    :goto_0
    iput-object p8, p0, Lqm/b;->p:LUk/n;

    new-instance p8, Lqm/a;

    const/4 p10, 0x0

    invoke-direct {p8, p0, p10}, Lqm/a;-><init>(Ljava/lang/Object;I)V

    invoke-static {p8}, Lkotlin/LazyKt;->lazy(Lxk1/a;)Lkotlin/Lazy;

    move-result-object p8

    iput-object p8, p0, Lqm/b;->q:Lkotlin/Lazy;
    ...
    new-instance p8, LCh/K;

    const/16 p10, 0xb

    invoke-direct {p8, p0, p10}, LCh/K;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p7, LA31/k;

    const/16 p8, 0xe

    invoke-direct {p7, p0, p8}, LA31/k;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p7, LA31/l;

    const/16 p8, 0xe

    invoke-direct {p7, p0, p8}, LA31/l;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p6, LMQ0/d;

    const/16 p7, 0x9

    invoke-direct {p6, p0, p7}, LMQ0/d;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p5, p6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance p5, LA31/a;

    const/4 p6, 0x6

    invoke-direct {p5, p0, p6}, LA31/a;-><init>(Ljava/lang/Object;I)V

    iget-object p6, p2, Lzm/B;->m:Landroidx/lifecycle/S;

    invoke-virtual {p6, p0, p5}, Landroidx/lifecycle/O;->g(Landroidx/lifecycle/J;Landroidx/lifecycle/U;)V

    new-instance p5, LA31/b;

    const/4 p6, 0x7

    invoke-direct {p5, p0, p6}, LA31/b;-><init>(Ljava/lang/Object;I)V

    iget-object p2, p2, Lzm/B;->n:Landroidx/lifecycle/S;

    invoke-virtual {p2, p0, p5}, Landroidx/lifecycle/O;->g(Landroidx/lifecycle/J;Landroidx/lifecycle/U;)V

    new-instance p2, LA31/c;

    const/4 p5, 0x5

    invoke-direct {p2, p0, p5}, LA31/c;-><init>(Ljava/lang/Object;I)V

    iget-object p5, p3, Lzm/z1;->e:Landroidx/lifecycle/i;

    invoke-virtual {p5, p0, p2}, Landroidx/lifecycle/O;->g(Landroidx/lifecycle/J;Landroidx/lifecycle/U;)V

    iget-object p2, p3, Lzm/z1;->i:Landroidx/lifecycle/T;

    new-instance p3, LCA/d;

    const/4 p5, 0x3

    invoke-direct {p3, p0, p5}, LCA/d;-><init>(Ljava/lang/Object;I)V
...
.method public final getLifecycle()Landroidx/lifecycle/t;
    ...
    iget-object p0, p0, Lqm/b;->a:Lcom/linecorp/line/album/ui/photoviewer/PhotoViewerFragment;
...
.method public final onDestroy(Landroidx/lifecycle/J;)V
    ...
    iget-object p1, p0, Lqm/b;->a:Lcom/linecorp/line/album/ui/photoviewer/PhotoViewerFragment;

...
.annotation runtime Lok1/f;
    c = "com.linecorp.registration.viewmodel.RegistrationViewModel$verifyPinCode$1"
...
.method public constructor <init>(LyV0/k;Ljava/lang/String;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, LyV0/d0;->b:LyV0/k;

    iput-object p2, p0, LyV0/d0;->c:Ljava/lang/String;
...
.method public final create(Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, LyV0/d0;

    iget-object v1, p0, LyV0/d0;->b:LyV0/k;

    iget-object p0, p0, LyV0/d0;->c:Ljava/lang/String;

    invoke-direct {v0, v1, p0, p1}, LyV0/d0;-><init>(LyV0/k;Ljava/lang/String;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, LyV0/d0;->create(Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p0

    check-cast p0, LyV0/d0;

    sget-object p1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p0, p1}, LyV0/d0;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v0, v5, LyV0/d0;->a:I

    iget-object v7, v5, LyV0/d0;->b:LyV0/k;
    ...
    iput v1, v5, LyV0/d0;->a:I

    iget-object v4, v5, LyV0/d0;->c:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    check-cast v0, Lcom/linecorp/registration/model/VerificationPhoneResponse;
    ...
    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getAccountExist()Z

    move-result v16

    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getAutoAddFriendDefaultValue()Z

    move-result v20

    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getAllowOthersToAddDefaultValue()Z

    move-result v21

    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getAllowedToRegister()Z
    ...
    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getSameUdidFromAccount()Z

    move-result v19

    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getDisplayName()Ljava/lang/String;

    move-result-object v15

    invoke-virtual {v0}, Lcom/linecorp/registration/model/VerificationPhoneResponse;->getProfileImageUrl()Ljava/lang/String;

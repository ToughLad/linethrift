.class public final Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl$a;->b:Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `yjsearch_keyword_history` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `keyword` TEXT NOT NULL, `last_search_time` INTEGER NOT NULL)"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'7f5aae4bd59b28803611a4060bca585f\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `yjsearch_keyword_history`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;->o:I

    iget-object p0, p0, Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl$a;->b:Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl$a;->b:Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;

    sget v1, Lcom/linecorp/line/yjsearch/impl/data/local/database/YJSearchDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v6, "last_search_time"
    ...
    const-string v4, "yjsearch_keyword_history"
    ...
    const-string v0, "yjsearch_keyword_history(com.linecorp.line.yjsearch.impl.data.local.database.model.HistoryKeywordEntity).\n Expected:\n"

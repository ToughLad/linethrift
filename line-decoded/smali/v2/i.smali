...
.method public static b(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lv2/i;->d(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lv2/i;->d(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static c([LD2/l$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, LD2/l$b;->a:Landroid/net/Uri;
    ...
    iget v7, v4, LD2/l$b;->c:I

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setWeight(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget-boolean v7, v4, LD2/l$b;->d:Z

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setSlant(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget v4, v4, LD2/l$b;->b:I
...
# virtual methods
.method public final a(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    .locals 3
    ...
    invoke-static {v2, p0}, Lv2/i;->c([LD2/l$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {p1, p3}, Lv2/i;->b(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;

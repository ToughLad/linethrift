...
.method public constructor <init>(Ljava/util/ArrayList;ZLM/a;)V
    ...
    iput-object p1, p0, LN/q;->a:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, LN/q;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, LN/n;

    invoke-direct {p1, p0}, LN/n;-><init>(LN/q;)V

    invoke-static {p1}, LZ1/b;->a(LZ1/b$c;)LZ1/b$d;

    move-result-object p1

    iput-object p1, p0, LN/q;->e:LZ1/b$d;

    new-instance p1, LN/o;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, LN/o;-><init>(Ljava/lang/Object;I)V

    invoke-static {}, Lw9/i5;->f()LM/a;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, LN/q;->p(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    iget-object p1, p0, LN/q;->a:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, LN/q;->f:LZ1/b$a;

    new-instance p2, Ljava/util/ArrayList;

    iget-object p0, p0, LN/q;->b:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v0, p0, LN/q;->a:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p2, p0, LN/q;->a:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p0, p1, v0}, LN/p;-><init>(LN/q;ILCb/k;)V

    invoke-interface {v0, v1, p3}, LCb/k;->p(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public final cancel(Z)Z
    ...
    :cond_0
    iget-object p0, p0, LN/q;->e:LZ1/b$d;

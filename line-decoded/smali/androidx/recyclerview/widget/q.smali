...
.method public static c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$D;
    .locals 5
    ...
    invoke-static {v3}, Landroidx/recyclerview/widget/RecyclerView;->X(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$D;
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$D;->f0()Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/recyclerview/widget/RecyclerView$u;->l(IJ)Landroidx/recyclerview/widget/RecyclerView$D;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$D;->e0()Z
    ...
    :cond_2
    invoke-virtual {v0, p1, v1}, Landroidx/recyclerview/widget/RecyclerView$u;->a(Landroidx/recyclerview/widget/RecyclerView$D;Z)V
    :try_end_0
...
.method public final a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_2
    iget-object p0, p1, Landroidx/recyclerview/widget/RecyclerView;->m8:Landroidx/recyclerview/widget/q$b;
...
.method public final b(J)V
    ...
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->m8:Landroidx/recyclerview/widget/q$b;

    invoke-virtual {v6, v5, v2}, Landroidx/recyclerview/widget/q$b;->b(Landroidx/recyclerview/widget/RecyclerView;Z)V

    iget v5, v6, Landroidx/recyclerview/widget/q$b;->d:I
    ...
    :cond_2
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->m8:Landroidx/recyclerview/widget/q$b;
    ...
    invoke-static {v3, v4, v6, v7}, Landroidx/recyclerview/widget/q;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$D;

    move-result-object v3

    if-eqz v3, :cond_9

    iget-object v4, v3, Landroidx/recyclerview/widget/RecyclerView$D;->b:Ljava/lang/ref/WeakReference;

    if-eqz v4, :cond_9

    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$D;->e0()Z
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView$D;->b:Ljava/lang/ref/WeakReference;
    ...
    :cond_a
    iget-boolean v4, v3, Landroidx/recyclerview/widget/RecyclerView;->M:Z

    if-eqz v4, :cond_d

    iget-object v4, v3, Landroidx/recyclerview/widget/RecyclerView;->f:Landroidx/recyclerview/widget/e;
    ...
    iget-object v4, v3, Landroidx/recyclerview/widget/RecyclerView;->i2:Landroidx/recyclerview/widget/RecyclerView$k;

    if-eqz v4, :cond_b

    invoke-virtual {v4}, Landroidx/recyclerview/widget/RecyclerView$k;->l()V

    :cond_b
    iget-object v4, v3, Landroidx/recyclerview/widget/RecyclerView;->n:Landroidx/recyclerview/widget/RecyclerView$n;

    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->c:Landroidx/recyclerview/widget/RecyclerView$u;

    if-eqz v4, :cond_c

    invoke-virtual {v4, v6}, Landroidx/recyclerview/widget/RecyclerView$n;->z0(Landroidx/recyclerview/widget/RecyclerView$u;)V

    iget-object v4, v3, Landroidx/recyclerview/widget/RecyclerView;->n:Landroidx/recyclerview/widget/RecyclerView$n;

    invoke-virtual {v4, v6}, Landroidx/recyclerview/widget/RecyclerView$n;->A0(Landroidx/recyclerview/widget/RecyclerView$u;)V

    :cond_c
    iget-object v4, v6, Landroidx/recyclerview/widget/RecyclerView$u;->a:Ljava/util/ArrayList;

    invoke-virtual {v4}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {v6}, Landroidx/recyclerview/widget/RecyclerView$u;->g()V

    :cond_d
    iget-object v4, v3, Landroidx/recyclerview/widget/RecyclerView;->m8:Landroidx/recyclerview/widget/q$b;
    ...
    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->n8:Landroidx/recyclerview/widget/RecyclerView$z;

    iget-object v7, v3, Landroidx/recyclerview/widget/RecyclerView;->m:Landroidx/recyclerview/widget/RecyclerView$f;

    iput v5, v6, Landroidx/recyclerview/widget/RecyclerView$z;->d:I
    ...
    iput-boolean v2, v6, Landroidx/recyclerview/widget/RecyclerView$z;->g:Z

    iput-boolean v2, v6, Landroidx/recyclerview/widget/RecyclerView$z;->h:Z

    iput-boolean v2, v6, Landroidx/recyclerview/widget/RecyclerView$z;->i:Z
    ...
    invoke-static {v3, v7, v8, v9}, Landroidx/recyclerview/widget/q;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$D;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

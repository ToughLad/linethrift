...
.method public final b(Landroidx/core/app/r;)V
    ...
    iget-object v2, v1, Landroidx/core/app/r;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v4, v0, Landroidx/core/app/j;->d:Landroidx/core/graphics/drawable/IconCompat;

    const/4 v5, 0x0

    iget-object v1, v1, Landroidx/core/app/r;->a:Landroid/content/Context;
    ...
    invoke-static {v3, v4}, Landroidx/core/app/j$b;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v4, v0, Landroidx/core/app/j;->f:Z

    if-eqz v4, :cond_7

    iget-object v4, v0, Landroidx/core/app/j;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v3, v1}, Landroidx/core/app/j$a;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Landroidx/core/app/p;->c:Z

    if-eqz v1, :cond_8

    iget-object v0, v0, Landroidx/core/app/p;->b:Ljava/lang/CharSequence;
    ...
    invoke-static {v3, v0}, Landroidx/core/app/j$b;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v3, v2}, Landroidx/core/app/j$b;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V

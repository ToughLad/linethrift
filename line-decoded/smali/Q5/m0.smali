...
.method public static final a(LCb/k;Landroidx/work/c;Lok1/j;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-static {p0}, LQ5/m0;->b(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    invoke-direct {p2, p0, v0}, LQ5/w;-><init>(LCb/k;LSl1/l;)V

    sget-object v1, LP5/g;->INSTANCE:LP5/g;

    invoke-interface {p0, p2, v1}, LCb/k;->p(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    new-instance p2, LQ5/l0;

    invoke-direct {p2, p1, p0}, LQ5/l0;-><init>(Landroidx/work/c;LCb/k;)V

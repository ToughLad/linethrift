...
# direct methods
.method public static a(Landroid/hardware/camera2/CaptureRequest$Builder;Landroidx/camera/core/impl/q0;)V
    .locals 3
    ...
    invoke-interface {p1}, Landroidx/camera/core/impl/z0;->f()Ljava/util/Set;
    ...
    invoke-virtual {v1}, Landroidx/camera/core/impl/Q$a;->c()Ljava/lang/Object;
...
.method public static b(Landroid/hardware/camera2/CaptureRequest$Builder;ILF/v;)V
    .locals 1
...
.method public static c(Landroidx/camera/core/impl/O;Landroid/hardware/camera2/CameraDevice;Ljava/util/HashMap;ZLF/v;)Landroid/hardware/camera2/CaptureRequest;
    .locals 8
    ...
    :cond_0
    iget-object v0, p0, Landroidx/camera/core/impl/O;->a:Ljava/util/ArrayList;
    ...
    iget v5, p0, Landroidx/camera/core/impl/O;->c:I

    if-ne v5, v4, :cond_4

    iget-object v6, p0, Landroidx/camera/core/impl/O;->h:Landroidx/camera/core/impl/w;

    if-eqz v6, :cond_4

    invoke-interface {v6}, Landroidx/camera/core/impl/w;->g()Landroid/hardware/camera2/CaptureResult;
    ...
    :goto_3
    invoke-static {p1, v5, p4}, LB/J0;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILF/v;)V

    sget-object p3, Landroidx/camera/core/impl/O;->k:Landroidx/camera/core/impl/d;

    sget-object p4, Landroidx/camera/core/impl/I0;->a:Landroid/util/Range;

    iget-object v2, p0, Landroidx/camera/core/impl/O;->b:Landroidx/camera/core/impl/q0;

    :try_start_0
    invoke-virtual {v2, p3}, Landroidx/camera/core/impl/q0;->a(Landroidx/camera/core/impl/Q$a;)Ljava/lang/Object;
    ...
    sget-object p3, Landroidx/camera/core/impl/I0;->a:Landroid/util/Range;
    ...
    sget-object v3, Landroidx/camera/core/impl/O;->k:Landroidx/camera/core/impl/d;
    ...
    :cond_7
    invoke-virtual {p0}, Landroidx/camera/core/impl/O;->b()I

    move-result p3

    if-eq p3, v0, :cond_a

    invoke-virtual {p0}, Landroidx/camera/core/impl/O;->c()I
    ...
    :cond_b
    :goto_5
    sget-object p2, Landroidx/camera/core/impl/O;->i:Landroidx/camera/core/impl/d;

    iget-object p3, v2, Landroidx/camera/core/impl/q0;->G:Ljava/util/TreeMap;
    ...
    invoke-virtual {v2, p2}, Landroidx/camera/core/impl/q0;->a(Landroidx/camera/core/impl/Q$a;)Ljava/lang/Object;
    ...
    :cond_c
    sget-object p2, Landroidx/camera/core/impl/O;->j:Landroidx/camera/core/impl/d;
    ...
    :cond_d
    invoke-static {p1, v2}, LB/J0;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Landroidx/camera/core/impl/q0;)V
...
.method public static d(Landroidx/camera/core/impl/O;Landroid/hardware/camera2/CameraDevice;LF/v;)Landroid/hardware/camera2/CaptureRequest;
    .locals 2
    ...
    invoke-static {p1, v0, p2}, LB/J0;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILF/v;)V

    iget-object p0, p0, Landroidx/camera/core/impl/O;->b:Landroidx/camera/core/impl/q0;

    invoke-static {p1, p0}, LB/J0;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Landroidx/camera/core/impl/q0;)V

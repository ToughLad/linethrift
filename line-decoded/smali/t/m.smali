...
.method public constructor <init>(Landroid/widget/AbsSeekBar;)V
    ...
    iput-object p1, p0, Lt/m;->a:Landroid/widget/AbsSeekBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lt/m;->a:Landroid/widget/AbsSeekBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v2, Lt/m;->c:[I
    ...
    invoke-virtual {p1, p2}, Lt/P;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v2}, Lt/m;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v2}, Lt/P;->c(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-virtual {p0, v1, p2}, Lt/m;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lw2/e;->b()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, p0}, Lw2/e;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Lt/m;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lt/m;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v1, p0, Lt/m;->b:Landroid/graphics/Bitmap;

...
# direct methods
.method public static a(LB3/B;)Ljava/util/ArrayList;
    .locals 30
    ...
    :try_start_0
    invoke-static {v0, v3, v4}, LB3/L;->G(LB3/B;LB3/B;Ljava/util/zip/Inflater;)Z
    ...
    invoke-direct {v2, v5, v9}, LB3/A;-><init>([BI)V

    iget v5, v0, LB3/B;->b:I

    const/16 v9, 0x8

    mul-int/2addr v5, v9

    invoke-virtual {v2, v5}, LB3/A;->m(I)V
    ...
    invoke-virtual {v2, v1}, LB3/A;->g(I)I
    ...
    invoke-virtual {v2, v1}, LB3/A;->m(I)V
    ...
    invoke-direct {v2, v12, v15, v5, v1}, La4/e$b;-><init>(II[F[F)V
    ...
    new-instance v1, La4/e$a;

    invoke-direct {v1, v8}, La4/e$a;-><init>([La4/e$b;)V

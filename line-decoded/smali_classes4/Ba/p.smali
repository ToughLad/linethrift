...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Rect;FZZ)V
    ...
    iput v0, p0, LBa/p;->b:F

    iget-object v0, p0, LBa/m;->a:LBa/c;
    ...
    iget p2, v0, LBa/c;->a:I

    div-int/lit8 v1, p2, 0x2

    iget v6, v0, LBa/c;->b:I
    ...
    iget p4, v0, LBa/c;->f:I

    if-eq p4, p2, :cond_7

    :cond_6
    iget p4, v0, LBa/c;->a:I
    ...
    iget p1, v0, LBa/c;->f:I

    if-ne p1, p2, :cond_8

    iput p3, p0, LBa/p;->f:F

    return-void

    :cond_8
    iput v5, p0, LBa/p;->f:F
...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Ld9/a;->c(II)I

    move-result p3

    iget-object p4, p0, LBa/m;->a:LBa/c;

    check-cast p4, LBa/v;

    iget v0, p4, LBa/v;->k:I
    ...
    iget p3, p0, LBa/p;->b:F

    const/high16 v0, 0x40000000    # 2.0f

    div-float/2addr p3, v0

    iget v1, p0, LBa/p;->c:F
    ...
    invoke-virtual/range {v1 .. v7}, LBa/p;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;LBa/m$a;I)V
    .locals 9

    iget v0, p3, LBa/m$a;->c:I

    invoke-static {v0, p4}, Ld9/a;->c(II)I

    move-result v6

    iget v4, p3, LBa/m$a;->a:F

    iget v5, p3, LBa/m$a;->b:F

    iget v7, p3, LBa/m$a;->d:I
    ...
    invoke-virtual/range {v1 .. v8}, LBa/p;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Ld9/a;->c(II)I

    move-result p5

    move p6, p7

    invoke-virtual/range {p0 .. p7}, LBa/p;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final e()I
    ...
    iget-object p0, p0, LBa/m;->a:LBa/c;
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, LA2/a;->e(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, LA2/a;->e(FFF)F

    move-result v2

    iget v3, p0, LBa/p;->f:F

    sub-float v3, v1, v3

    invoke-static {v3, v1, p3}, LG2/c;->i(FFF)F
    ...
    invoke-static {v3, v1, v2}, LG2/c;->i(FFF)F
    ...
    invoke-static {p3, v0, v4}, LA2/a;->e(FFF)F
    ...
    invoke-static {v2, v6, v1}, LA2/a;->e(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, LBa/p;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
    ...
    iget-boolean v6, p0, LBa/p;->e:Z

    if-nez v6, :cond_3

    iget v6, p0, LBa/p;->d:F
...
.method public final h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
    ...
    iget v0, p0, LBa/p;->c:F

    invoke-static {p6, v0}, Ljava/lang/Math;->min(FF)F

    move-result p6

    iget v0, p0, LBa/p;->d:F

    mul-float/2addr v0, p6

    iget p0, p0, LBa/p;->c:F

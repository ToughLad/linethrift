...
.method public static a(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    :cond_0
    invoke-static {v9, v11}, LUa/n;->a(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    invoke-static {v9, v10}, LUa/n;->a(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    :goto_1
    invoke-static {v0}, LUa/n;->b(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1, v2}, LUa/m;->e(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct/range {v12 .. v20}, LUa/k;-><init>(Ljava/nio/ByteBuffer;JJJLjava/nio/ByteBuffer;)V

    invoke-virtual {v9}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object v0

    invoke-static {v0, v12}, LUa/m;->k(Ljava/nio/channels/FileChannel;LUa/k;)[[Ljava/security/cert/X509Certificate;
...
.method public static f(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v0}, LUa/m;->e(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
...
.method public static i(Ljava/nio/ByteBuffer;Ljava/util/HashMap;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static/range {p0 .. p0}, LUa/m;->f(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {p0 .. p0}, LUa/m;->h(Ljava/nio/ByteBuffer;)[B
    ...
    :try_start_0
    invoke-static {v1}, LUa/m;->f(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v6}, LUa/m;->c(I)I

    move-result v12

    invoke-static {v7}, LUa/m;->c(I)I
    ...
    :cond_2
    invoke-static {v10}, LUa/m;->h(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {v0}, LUa/m;->f(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v8}, LUa/m;->h(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {v1}, LUa/m;->d(I)Ljava/lang/String;
    ...
    invoke-static {v0}, LUa/m;->h(Ljava/nio/ByteBuffer;)[B
    ...
    new-instance v7, LUa/l;

    invoke-direct {v7, v5, v4}, LUa/l;-><init>(Ljava/security/cert/X509Certificate;[B)V
...
.method public static j([I[LUa/e;)[[B
    .locals 25
    ...
    invoke-interface {v9}, LUa/e;->zza()J
    ...
    invoke-static {v11, v12}, LUa/m;->g(I[B)V
    ...
    invoke-static {v13}, LUa/m;->d(I)Ljava/lang/String;
    ...
    invoke-interface {v1}, LUa/e;->zza()J
    ...
    invoke-static {v12, v5}, LUa/m;->g(I[B)V
    ...
    :cond_3
    :try_start_1
    invoke-interface {v1, v6, v9, v10, v12}, LUa/e;->zzb([Ljava/security/MessageDigest;JI)V
    :try_end_1
    ...
    invoke-static {v3}, LUa/m;->d(I)Ljava/lang/String;
...
.method public static k(Ljava/nio/channels/FileChannel;LUa/k;)[[Ljava/security/cert/X509Certificate;
    .locals 18
    ...
    :try_start_1
    iget-object v6, v0, LUa/k;->a:Ljava/nio/ByteBuffer;

    invoke-static {v6}, LUa/m;->f(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v8, v3, v5}, LUa/m;->i(Ljava/nio/ByteBuffer;Ljava/util/HashMap;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    iget-wide v10, v0, LUa/k;->b:J

    move-object/from16 v7, p0

    invoke-direct/range {v6 .. v11}, LUa/j;-><init>(Ljava/nio/channels/FileChannel;JJ)V

    iget-wide v7, v0, LUa/k;->d:J

    iget-wide v14, v0, LUa/k;->c:J

    sub-long v16, v7, v14

    new-instance v12, LUa/j;

    move-object/from16 v13, p0

    invoke-direct/range {v12 .. v17}, LUa/j;-><init>(Ljava/nio/channels/FileChannel;JJ)V

    iget-object v0, v0, LUa/k;->e:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, v5, LD11/a;->a:Ljava/lang/Object;
    ...
    invoke-static {v7, v8}, LUa/m;->j([I[LUa/e;)[[B
    ...
    invoke-static {v6}, LUa/m;->d(I)Ljava/lang/String;

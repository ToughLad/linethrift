.class public final Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl;


# direct methods
.method public constructor <init>(Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl;)V
    .locals 0

    iput-object p1, p0, Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl$a;->b:Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `iab_search_bar_history` (`keyword` TEXT NOT NULL, `entry_timestamp_millis` INTEGER NOT NULL, PRIMARY KEY(`keyword`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'6163752a74d21b9d471c751f4f2defa5\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `iab_search_bar_history`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    iget-object p0, p0, Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl$a;->b:Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl;
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl$a;->b:Ljp/naver/line/android/activity/iab/search/IabSearchBarHistoryDatabase_Impl;
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v5, "entry_timestamp_millis"
    ...
    const-string v0, "entry_timestamp_millis"
    ...
    const-string v4, "iab_search_bar_history"
    ...
    const-string v0, "iab_search_bar_history(jp.naver.line.android.activity.iab.search.IabSearchBarHistoryItem).\n Expected:\n"

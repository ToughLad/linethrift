.class public final Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl;
...
.method public constructor <init>(Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl;)V
    ...
    iput-object p1, p0, Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl$a;->b:Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `iab_location_permission` (`origin` TEXT NOT NULL, `is_granted` INTEGER NOT NULL, `request_timestamp_millis` INTEGER NOT NULL, PRIMARY KEY(`origin`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'f4350d342902cea3fa10cd1bf958cef5\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `iab_location_permission`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    iget-object p0, p0, Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl$a;->b:Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl;
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl$a;->b:Ljp/naver/line/android/activity/iab/IabLocationPermissionDatabase_Impl;
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v6, "request_timestamp_millis"
    ...
    const-string v0, "request_timestamp_millis"
    ...
    const-string v4, "iab_location_permission"
    ...
    const-string v0, "iab_location_permission(jp.naver.line.android.activity.iab.IabLocationPermissionData).\n Expected:\n"

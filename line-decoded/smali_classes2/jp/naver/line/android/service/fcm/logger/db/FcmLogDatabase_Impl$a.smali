.class public final Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;
...
.method public constructor <init>(Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;)V
    ...
    iput-object p1, p0, Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl$a;->b:Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `fcm_log` (`push_tracking_id` TEXT NOT NULL, `timestamp` INTEGER, `battery_percentage` INTEGER, `battery_mode` INTEGER, `client_network_type` INTEGER, `carrier_code` TEXT, `display_timestamp` INTEGER, PRIMARY KEY(`push_tracking_id`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'69152849c4240e6abc0907d630d35b15\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `fcm_log`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;->o:I

    iget-object p0, p0, Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl$a;->b:Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl$a;->b:Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;

    sget v1, Ljp/naver/line/android/service/fcm/logger/db/FcmLogDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v4, "push_tracking_id"
    ...
    const-string v8, "client_network_type"
    ...
    const-string v0, "client_network_type"
    ...
    invoke-static {p0, v0, v7, v1}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v0, "fcm_log(jp.naver.line.android.service.fcm.logger.db.FcmLog).\n Expected:\n"

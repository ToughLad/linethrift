...
.method public final d(Landroid/content/Context;Ljava/lang/String;LFj1/l;Ljava/util/LinkedHashMap;)LFj1/j;
    ...
    sget-object p3, LaU0/f;->b:LaU0/f$a;

    invoke-static {p3, p1}, LAC/a;->j(LNi/a;Landroid/content/Context;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, LaU0/f;

    invoke-virtual {p3}, LaU0/f;->b()Z

    move-result p3

    if-eqz p3, :cond_2

    sget-object p3, Lfh0/k;->THINGS_DEVICE_MANAGEMENT:Lfh0/k;

    sget-object p4, Lcom/linecorp/linethings/devicemanagement/ThingsPolicyAgreementStarterFragment;->c:[LLv0/h;

    const-string p4, "IMPRESSION_SCREEN_NAME"
    ...
    invoke-static {p2, p1, p3, p0, p4}, Lcom/linecorp/line/settings/base/LineUserSettingsTwoPaneFragmentActivity$a;->f(Lcom/linecorp/line/settings/base/LineUserSettingsTwoPaneFragmentActivity$a;Landroid/content/Context;Lfh0/k;Landroid/os/Bundle;I)Landroid/content/Intent;

...
# virtual methods
.method public final b(Ljava/lang/ref/WeakReference;)LAT/l;
    .locals 1
    ...
    iput-object v0, p0, LAT/l;->a:Ljava/lang/Object;
...
.method public final g(Landroid/text/Spanned;)Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;
    .locals 0
    ...
    invoke-static {p1}, LGL/b;->h(Landroid/text/Spanned;)Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;
...
.method public final j(Landroid/content/Context;Landroid/text/SpannableStringBuilder;)I
    ...
    invoke-static {p2}, LGL/b;->h(Landroid/text/Spanned;)Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;
    ...
    invoke-virtual {p0}, Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;->b()Loi1/c;
...
.method public final k(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/linecorp/line/timeline/userrecall/UserRecallEditText;)Lox0/F;
    .locals 0

    new-instance p0, Lox0/F;

    invoke-direct {p0, p1, p2}, Lox0/F;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/linecorp/line/timeline/userrecall/UserRecallEditText;)V

    return-object p0
.end method

.method public final l(Ljava/lang/Object;Ljava/lang/CharSequence;Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;Lxk1/l;)V
    .locals 0
    ...
    invoke-direct {p0, p2, p3, p4}, Lnh1/f$c;-><init>(Ljava/lang/CharSequence;Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;Lxk1/l;)V
...
.method public final m(Landroid/content/Context;)Lqn0/c;
    .locals 0
...
.method public final n(Lcom/linecorp/line/timeline/userrecall/UserRecallEditText;)LOb1/b;
    .locals 1
...
.method public final o(Lcom/linecorp/line/timeline/userrecall/UserRecallEditText;)V
    .locals 0
...
.method public final p(Lcom/linecorp/line/timeline/userrecall/UserRecallEditText;)LCu/a;
    .locals 1
    ...
    iput-object v0, p0, LCu/a;->a:Ljava/lang/Object;

    return-object p0
.end method

.method public final q(Landroid/content/Context;Landroid/widget/ImageView;Low0/b;)Lox0/E;
    .locals 0

    new-instance p0, Lox0/E;

    invoke-direct {p0, p1, p2, p3}, Lox0/E;-><init>(Landroid/content/Context;Landroid/widget/ImageView;Low0/b;)V

    return-object p0
.end method

.method public final r(JLandroid/content/Context;)LAn0/d;
    .locals 0
    ...
    invoke-interface {p0, p1, p2}, LlZ0/a;->d(J)LAn0/d;
...
.method public final s(Landroid/content/Context;Landroid/text/SpannableStringBuilder;Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;I)Ljava/lang/String;
    .locals 5
    ...
    invoke-virtual {p3}, Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;->b()Loi1/c;
    ...
    invoke-virtual {p3}, Lcom/linecorp/line/timeline/model/sticon/PostSticonMetaList;->d()Lzn0/j;

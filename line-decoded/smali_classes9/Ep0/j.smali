...
# virtual methods
.method public final a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/view/ViewStub;Landroidx/lifecycle/J;Landroidx/lifecycle/z0;Landroidx/lifecycle/O;Lok1/d;)Ljava/lang/Object;
    .locals 22
    ...
    instance-of v4, v3, LEp0/k;

    if-eqz v4, :cond_0

    move-object v4, v3

    check-cast v4, LEp0/k;

    iget v5, v4, LEp0/k;->k:I
    ...
    iput v5, v4, LEp0/k;->k:I

    goto :goto_0

    :cond_0
    new-instance v4, LEp0/k;

    invoke-direct {v4, v0, v3}, LEp0/k;-><init>(LEp0/j;Lok1/d;)V

    :goto_0
    iget-object v3, v4, LEp0/k;->i:Ljava/lang/Object;

    sget-object v5, Lnk1/a;->COROUTINE_SUSPENDED:Lnk1/a;

    iget v6, v4, LEp0/k;->k:I
    ...
    iget-object v0, v4, LEp0/k;->h:Landroidx/lifecycle/O;

    iget-object v1, v4, LEp0/k;->g:Landroidx/lifecycle/z0;

    iget-object v2, v4, LEp0/k;->f:Landroidx/lifecycle/J;

    iget-object v5, v4, LEp0/k;->e:Landroid/view/ViewStub;

    iget-object v6, v4, LEp0/k;->d:Ljava/lang/String;

    iget-object v8, v4, LEp0/k;->c:Ljava/lang/String;

    iget-object v9, v4, LEp0/k;->b:Landroid/content/Context;

    iget-object v4, v4, LEp0/k;->a:LEp0/j;
    ...
    iput-object v0, v4, LEp0/k;->a:LEp0/j;

    iput-object v1, v4, LEp0/k;->b:Landroid/content/Context;

    move-object/from16 v3, p2

    iput-object v3, v4, LEp0/k;->c:Ljava/lang/String;

    iput-object v2, v4, LEp0/k;->d:Ljava/lang/String;

    move-object/from16 v6, p4

    iput-object v6, v4, LEp0/k;->e:Landroid/view/ViewStub;

    move-object/from16 v8, p5

    iput-object v8, v4, LEp0/k;->f:Landroidx/lifecycle/J;

    move-object/from16 v9, p6

    iput-object v9, v4, LEp0/k;->g:Landroidx/lifecycle/z0;

    move-object/from16 v10, p7

    iput-object v10, v4, LEp0/k;->h:Landroidx/lifecycle/O;

    iput v7, v4, LEp0/k;->k:I
    ...
    sget-object v12, Lvs0/b;->THREAD_CHAT:Lvs0/b;
    ...
    sget-object v6, LEp0/j$a;->$EnumSwitchMapping$0:[I
    ...
    new-instance v16, LNp0/c;

    sget-object v17, Lvs0/b;->THREAD_CHAT:Lvs0/b;
    ...
    invoke-direct {v0, v8, v2, v5}, LNp0/f;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v4}, Lsq0/a;->E()Ljava/lang/String;
    ...
    invoke-direct/range {v16 .. v21}, LNp0/c;-><init>(Lvs0/b;LNp0/f;Ljava/lang/String;J)V

    move-object/from16 v0, v16

    new-instance v1, LNp0/b;

    sget-object v2, Ldq0/a;->a:Ldq0/a$a;
    ...
    invoke-direct {v1, v2}, LNp0/b;-><init>(LYp0/a;)V
    ...
    invoke-direct {v2, v4, v0, v1}, LOp0/d$b;-><init>(Landroid/content/Context;LNp0/c;LNp0/e;)V
    ...
    instance-of v1, v3, Landroidx/lifecycle/r;
    ...
    sget-object v5, Lvs0/b;->THREAD_CHAT:Lvs0/b;
    ...
    invoke-interface {v7}, Lsq0/a;->h()Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p5}, LLp0/B;-><init>(Landroidx/lifecycle/O;Landroid/view/ViewStub;LPp0/c;LKp0/a;Landroidx/lifecycle/J;)V

    move-object/from16 v0, p0

    iget-object v0, v0, LLp0/B;->e:Landroidx/lifecycle/T;

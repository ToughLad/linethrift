...
.method public constructor <init>(Lcom/linecorp/line/voomcamera/editor/impl/EditorHostFragment;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LCK0/v;->a:Lcom/linecorp/line/voomcamera/editor/impl/EditorHostFragment;

    iput-object p2, p0, LCK0/v;->b:Ljava/lang/String;
    ...
    iput-object p2, p0, LCK0/v;->c:LVl1/J0;

    invoke-static {p2}, LVl1/k;->a(LVl1/D0;)LVl1/F0;

    move-result-object p2

    iput-object p2, p0, LCK0/v;->d:LVl1/F0;
    ...
    invoke-direct {v0, p0}, LCK0/u;-><init>(LCK0/v;)V

    const-string p0, "FilterFragmentNavigator_fragment_request_key"

...
.method public constructor <init>(Lcom/linecorp/line/voomcamera/editor/impl/EditorHostFragment;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LCK0/D;->a:Lcom/linecorp/line/voomcamera/editor/impl/EditorHostFragment;

    iput-object p2, p0, LCK0/D;->b:Ljava/lang/String;
    ...
    iput-object p2, p0, LCK0/D;->c:LVl1/J0;

    invoke-static {p2}, LVl1/k;->a(LVl1/D0;)LVl1/F0;

    move-result-object p2

    iput-object p2, p0, LCK0/D;->d:LVl1/F0;
    ...
    invoke-direct {v0, p0}, LCK0/C;-><init>(LCK0/D;)V

    const-string p0, "VoiceDubbingFragmentNavigator_fragment_request_key"

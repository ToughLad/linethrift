.class public final Lcom/linecorp/line/timeline/database/PostFeedDb_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/timeline/database/PostFeedDb_Impl$a;->b:Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `post_feeds` (`post` BLOB NOT NULL, `recommend_id` TEXT NOT NULL, `session_id` TEXT NOT NULL, `video_object_id` TEXT NOT NULL, `is_blinded` INTEGER NOT NULL, `recommend_cause` TEXT, `unconcern_available` INTEGER, `catalog_data_origin` TEXT, `catalog_writer_id` TEXT, `catalog_post_type` INTEGER, `catalog_user_type` TEXT, `theme_keyword` TEXT, `theme_post_data_origin` TEXT, `post_id` TEXT NOT NULL, `shared_post_id` TEXT, `is_visible_on_lights_viewer` INTEGER NOT NULL, `uid` TEXT NOT NULL, `screen_id` TEXT NOT NULL, `_id` INTEGER NOT NULL, PRIMARY KEY(`_id`))"

    const-string v0, "CREATE INDEX IF NOT EXISTS `index_post_feeds_screen_id` ON `post_feeds` (`screen_id`)"

    const-string v1, "CREATE INDEX IF NOT EXISTS `index_post_feeds_post_id` ON `post_feeds` (`post_id`)"

    const-string v2, "CREATE TABLE IF NOT EXISTS `post_feeds_paging` (`screen_id` TEXT NOT NULL, `next_scroll_id` TEXT, PRIMARY KEY(`screen_id`))"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'5b9a42bf0afffdc49b301346474e9168\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `post_feeds`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "DROP TABLE IF EXISTS `post_feeds_paging`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;->q:I

    iget-object p0, p0, Lcom/linecorp/line/timeline/database/PostFeedDb_Impl$a;->b:Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;->q:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/timeline/database/PostFeedDb_Impl$a;->b:Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;

    sget v1, Lcom/linecorp/line/timeline/database/PostFeedDb_Impl;->q:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v9, "video_object_id"
    ...
    const-string v11, "recommend_cause"
    ...
    const-string v2, "recommend_cause"
    ...
    const-string v12, "unconcern_available"
    ...
    const-string v2, "unconcern_available"
    ...
    const-string v13, "catalog_data_origin"
    ...
    const-string v2, "catalog_data_origin"
    ...
    const-string v6, "catalog_writer_id"
    ...
    const-string v2, "catalog_writer_id"
    ...
    const-string v7, "catalog_post_type"
    ...
    const-string v2, "catalog_post_type"
    ...
    const-string v8, "catalog_user_type"
    ...
    const-string v2, "catalog_user_type"
    ...
    const-string v10, "theme_post_data_origin"
    ...
    const-string v2, "theme_post_data_origin"
    ...
    const-string v12, "shared_post_id"
    ...
    const-string v13, "is_visible_on_lights_viewer"
    ...
    const-string v12, "index_post_feeds_screen_id"

    invoke-direct {v8, v12, v6, v9, v11}, Lk5/d$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    const-string v10, "index_post_feeds_post_id"

    invoke-direct {v8, v10, v6, v2, v9}, Lk5/d$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V

    invoke-virtual {v5, v8}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    new-instance v2, Lk5/d;

    const-string v8, "post_feeds"

    invoke-direct {v2, v8, v1, v4, v5}, Lk5/d;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    const-string v3, "post_feeds(com.linecorp.line.timeline.model.PostFeed).\n Expected:\n"
    ...
    const-string v12, "next_scroll_id"
    ...
    const-string v7, "post_feeds_paging"
    ...
    const-string v2, "post_feeds_paging(com.linecorp.line.timeline.database.PostFeedsPaging).\n Expected:\n"

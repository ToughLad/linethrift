...
.field public final b:LYS/p;

.field public final c:Lcom/linecorp/line/media/picker/fragment/sticker/MediaStickerFragment;

.field public final d:Landroidx/recyclerview/widget/RecyclerView;

.field public final e:Lcom/linecorp/line/media/picker/fragment/sticker/view/UnableToScrollLastPageViewPager;


# direct methods
.method public constructor <init>(LYS/s;LYS/p;Lcom/linecorp/line/media/picker/fragment/sticker/MediaStickerFragment;Lcom/bumptech/glide/m;Landroidx/recyclerview/widget/RecyclerView;Lcom/linecorp/line/media/picker/fragment/sticker/view/UnableToScrollLastPageViewPager;)V
    .locals 3
    ...
    iput-object p1, p0, LRS/A;->a:LYS/s;

    iput-object p2, p0, LRS/A;->b:LYS/p;

    iput-object p3, p0, LRS/A;->c:Lcom/linecorp/line/media/picker/fragment/sticker/MediaStickerFragment;

    iput-object p5, p0, LRS/A;->d:Landroidx/recyclerview/widget/RecyclerView;

    iput-object p6, p0, LRS/A;->e:Lcom/linecorp/line/media/picker/fragment/sticker/view/UnableToScrollLastPageViewPager;
    ...
    invoke-direct {v0, p2, p4, v1}, LSS/x;-><init>(LYS/p;Lcom/bumptech/glide/m;Landroidx/lifecycle/T;)V
    ...
    new-instance p4, LRS/u;

    invoke-direct {p4, p0}, LRS/u;-><init>(LRS/A;)V

    invoke-virtual {p5, p4}, Landroidx/recyclerview/widget/RecyclerView;->o(Landroidx/recyclerview/widget/RecyclerView$s;)V

    new-instance p4, LSS/u;

    invoke-direct {p4, p1, p2, p3}, LSS/u;-><init>(LYS/s;LYS/p;Lcom/linecorp/line/media/picker/fragment/sticker/MediaStickerFragment;)V

    invoke-virtual {p6, p4}, Landroidx/viewpager/widget/ViewPager;->setAdapter(Lz5/a;)V

    new-instance p1, LRS/v;

    invoke-direct {p1, p0}, LRS/v;-><init>(LRS/A;)V

    invoke-virtual {p6, p1}, Landroidx/viewpager/widget/ViewPager;->c(Landroidx/viewpager/widget/ViewPager$j;)V

    iget-object p1, p2, LYS/p;->c:Landroidx/lifecycle/T;

    invoke-static {p1, p3}, LW80/c;->a(Landroidx/lifecycle/O;Landroidx/lifecycle/J;)Lnv/b;

    move-result-object p1

    new-instance p4, LRS/w;

    const/4 p5, 0x0

    invoke-direct {p4, p0, p5}, LRS/w;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, p4}, Lnv/b;->b(Landroidx/lifecycle/U;)LHk1/i;

    iget-object p1, p2, LYS/p;->d:Landroidx/lifecycle/T;

    invoke-static {p1, p3}, LW80/c;->a(Landroidx/lifecycle/O;Landroidx/lifecycle/J;)Lnv/b;

    move-result-object p1

    new-instance p4, LRS/x;

    const/4 p5, 0x0

    invoke-direct {p4, p0, p5}, LRS/x;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, p4}, Lnv/b;->b(Landroidx/lifecycle/U;)LHk1/i;

    iget-object p1, p2, LYS/p;->i:Lsb1/a;

    invoke-static {p1, p3}, LW80/c;->a(Landroidx/lifecycle/O;Landroidx/lifecycle/J;)Lnv/b;

    move-result-object p1

    new-instance p4, LRS/y;

    const/4 p5, 0x0

    invoke-direct {p4, p0, p5}, LRS/y;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, p4}, Lnv/b;->b(Landroidx/lifecycle/U;)LHk1/i;

    iget-object p1, p2, LYS/p;->k:Lsb1/a;
    ...
    invoke-direct {p2, p0, p3}, LRS/z;-><init>(Ljava/lang/Object;I)V

.class public final Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl$a;->b:Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `RecentGallerySticker` (`uniqueId` TEXT NOT NULL, `stickerId` TEXT NOT NULL, `stickerName` TEXT NOT NULL, `packageId` TEXT NOT NULL, `unicodeEmoji` TEXT NOT NULL, `itemIndexOfOriginList` INTEGER NOT NULL, `thumbnailUrl` TEXT NOT NULL, `drawerImgType` TEXT NOT NULL, PRIMARY KEY(`uniqueId`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS `RecentLineSticker` (`stickerName` TEXT NOT NULL, `stickerId` TEXT NOT NULL, `packageId` INTEGER NOT NULL, `itemIndexOfOriginList` INTEGER NOT NULL, PRIMARY KEY(`stickerName`))"

    const-string v1, "CREATE TABLE IF NOT EXISTS `RecentLineSticon` (`sticonName` TEXT NOT NULL, `packageId` TEXT NOT NULL, `packageVersion` INTEGER NOT NULL, `sticonId` TEXT NOT NULL, `itemIndexOfOriginList` INTEGER NOT NULL, PRIMARY KEY(`sticonName`))"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'9aa29d7aac9fb4d273e7b59e62a574a6\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `RecentGallerySticker`"

    const-string v1, "DROP TABLE IF EXISTS `RecentLineSticker`"

    const-string v2, "DROP TABLE IF EXISTS `RecentLineSticon`"
    ...
    iget-object p0, p0, Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl$a;->b:Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl;
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl$a;->b:Lcom/linecorp/line/media/picker/fragment/sticker/database/RecentStickerDatabase_Impl;
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v11, "itemIndexOfOriginList"
    ...
    const-string v13, "drawerImgType"
    ...
    const-string v10, "RecentGallerySticker"
    ...
    const-string v2, "RecentGallerySticker(com.linecorp.line.media.picker.fragment.sticker.database.entity.RecentGallerySticker).\n Expected:\n"
    ...
    const-string v15, "itemIndexOfOriginList"
    ...
    const-string v9, "RecentLineSticker"
    ...
    const-string v2, "RecentLineSticker(com.linecorp.line.media.picker.fragment.sticker.database.entity.RecentLineSticker).\n Expected:\n"
    ...
    const-string v14, "packageVersion"
    ...
    const-string v16, "itemIndexOfOriginList"
    ...
    const-string v5, "RecentLineSticon"
    ...
    const-string v2, "RecentLineSticon(com.linecorp.line.media.picker.fragment.sticker.database.entity.RecentLineSticon).\n Expected:\n"

.class public final Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl$a;->b:Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `lights_draft` (`id` TEXT NOT NULL, `is_auto_draft` INTEGER NOT NULL, `hash_tag` TEXT NOT NULL, `body_text` TEXT NOT NULL, `select_account_mid` TEXT NOT NULL, `share_scope` TEXT NOT NULL, `share_group_list` TEXT NOT NULL, `allow_download_state` TEXT NOT NULL, `is_download_available` INTEGER NOT NULL, `launch_from` TEXT NOT NULL, PRIMARY KEY(`id`))"

    const-string v0, "CREATE INDEX IF NOT EXISTS `index_lights_draft_id` ON `lights_draft` (`id`)"

    const-string v1, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v2, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'6d55ef9c5d4551efcd7990a708c8c418\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `lights_draft`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    iget-object p0, p0, Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl$a;->b:Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl;
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl$a;->b:Lcom/linecorp/line/lights/composer/impl/draft/repository/dao/LightsDraftDb_Impl;
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v2, "select_account_mid"
    ...
    const-string v2, "share_group_list"
    ...
    const-string v2, "allow_download_state"
    ...
    const-string v2, "is_download_available"
    ...
    invoke-static {v0, v2, v3, v4}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v8, "index_lights_draft_id"

    invoke-direct {v6, v8, v4, v1, v7}, Lk5/d$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V

    invoke-virtual {v3, v6}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    new-instance v1, Lk5/d;

    const-string v6, "lights_draft"

    invoke-direct {v1, v6, v0, v2, v3}, Lk5/d;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    invoke-virtual {v1, v0}, Lk5/d;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_0

    new-instance v2, Lf5/s$b;

    const-string v3, "lights_draft(com.linecorp.line.lights.composer.impl.draft.model.LightsDraftItem).\n Expected:\n"

    const-string v5, "\n Found:\n"

    invoke-static {v3, v1, v5, v0}, LQ5/N;->a(Ljava/lang/String;Lk5/d;Ljava/lang/String;Lk5/d;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v4, v0}, Lf5/s$b;-><init>(ZLjava/lang/String;)V

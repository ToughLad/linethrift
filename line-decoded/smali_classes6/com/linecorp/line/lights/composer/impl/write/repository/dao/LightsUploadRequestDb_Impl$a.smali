.class public final Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl$a;->b:Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `lights_upload_request` (`accountInfo` TEXT NOT NULL, `shareScope` TEXT NOT NULL, `shareGroupList` TEXT NOT NULL, `postContents` TEXT NOT NULL, `allowDownloadState` TEXT NOT NULL, `saveVideoToDevice` INTEGER NOT NULL, `logParams` TEXT, `requestId` TEXT NOT NULL, `lightsPostId` TEXT NOT NULL, `launchFrom` TEXT NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT)"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'814841f8bfb859e5b82d95d355bd5a03\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `lights_upload_request`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    iget-object p0, p0, Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl$a;->b:Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl;
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl$a;->b:Lcom/linecorp/line/lights/composer/impl/write/repository/dao/LightsUploadRequestDb_Impl;
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v7, "shareGroupList"
    ...
    const-string v9, "allowDownloadState"
    ...
    const-string v10, "saveVideoToDevice"
    ...
    const-string v1, "saveVideoToDevice"
    ...
    const-string v5, "lights_upload_request"
    ...
    const-string v3, "lights_upload_request(com.linecorp.line.lights.composer.impl.write.model.LightsUploadRequestData).\n Expected:\n"

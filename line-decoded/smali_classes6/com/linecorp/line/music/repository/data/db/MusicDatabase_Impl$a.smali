.class public final Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl$a;->b:Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `music_track` (`track_id` TEXT NOT NULL, `title` TEXT NOT NULL, `artist_name` TEXT NOT NULL, `created_time` INTEGER NOT NULL, `liff_link_url` TEXT NOT NULL, `line_music_link_url` TEXT NOT NULL, `album_image_url` TEXT, PRIMARY KEY(`track_id`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'41fbd39322e16933477115aacb698346\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `music_track`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;->o:I

    iget-object p0, p0, Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl$a;->b:Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl$a;->b:Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;

    sget v1, Lcom/linecorp/line/music/repository/data/db/MusicDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v9, "line_music_link_url"
    ...
    const-string v0, "line_music_link_url"
    ...
    const-string v10, "album_image_url"
    ...
    const-string v0, "music_track(com.linecorp.line.music.repository.data.db.track.entity.MusicTrackEntity).\n Expected:\n"

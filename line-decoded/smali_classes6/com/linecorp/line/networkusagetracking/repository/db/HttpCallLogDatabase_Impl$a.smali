.class public final Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl$a;->b:Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `http_call_log` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `url` TEXT NOT NULL, `start_time_millis` INTEGER NOT NULL, `end_time_millis` INTEGER NOT NULL, `method` TEXT NOT NULL, `connectivity` TEXT NOT NULL, `req_header_size` INTEGER NOT NULL, `req_body_size` INTEGER NOT NULL, `req_content_type` TEXT, `res_header_size` INTEGER NOT NULL, `res_body_size` INTEGER NOT NULL, `res_content_type` TEXT, `res_code` INTEGER NOT NULL, `total_size` INTEGER NOT NULL, `is_foreground` INTEGER NOT NULL)"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'715fc50cbd1eecfea100095d08b43509\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `http_call_log`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;->o:I

    iget-object p0, p0, Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl$a;->b:Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl$a;->b:Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;

    sget v1, Lcom/linecorp/line/networkusagetracking/repository/db/HttpCallLogDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v1, "req_header_size"
    ...
    const-string v5, "req_content_type"
    ...
    const-string v6, "res_header_size"
    ...
    const-string v1, "res_header_size"
    ...
    const-string v8, "res_content_type"
    ...
    invoke-static {v0, v1, v8, v2}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v3, "http_call_log(com.linecorp.line.networkusagetracking.repository.db.HttpCallLogEntity).\n Expected:\n"

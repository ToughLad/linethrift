.class public final Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl$a;->b:Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `contact_calendar_event` (`contact_mid` TEXT NOT NULL, `event_type` INTEGER NOT NULL, `event_date_index` TEXT NOT NULL, `year` INTEGER, `month` INTEGER, `day` INTEGER, `snapshot_time` INTEGER NOT NULL, PRIMARY KEY(`contact_mid`, `event_type`, `event_date_index`))"

    const-string v0, "CREATE INDEX IF NOT EXISTS `index_contact_calendar_event_month_day` ON `contact_calendar_event` (`month`, `day`)"

    const-string v1, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v2, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'2688911a1d47e2108b01ea5be205e94c\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `contact_calendar_event`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    iget-object p0, p0, Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl$a;->b:Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl;
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl$a;->b:Lcom/linecorp/line/mainchatdata/event/EventsDatabase_Impl;
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v6, "event_date_index"
    ...
    const-string v0, "event_date_index"
    ...
    const-string v10, "snapshot_time"
    ...
    const-string v7, "index_contact_calendar_event_month_day"

    invoke-direct {v6, v7, v3, v0, v1}, Lk5/d$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V

    invoke-virtual {v4, v6}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    new-instance v0, Lk5/d;

    const-string v1, "contact_calendar_event"
    ...
    const-string v1, "contact_calendar_event(com.linecorp.line.mainchatdata.event.ContactCalendarEvent).\n Expected:\n"

...
.method public constructor <init>(LER/c;)V
    ...
    :goto_0
    iput-object v0, p0, LCR/c;->b:LRU0/b;

    const/4 v0, -0x1

    iput v0, p0, LCR/c;->c:I

    const-string v1, "DimRenderProgram creation fails."

    invoke-static {v1}, LN1/L;->b(Ljava/lang/String;)V

    iget-object v1, p0, LCR/c;->b:LRU0/b;

    if-eqz v1, :cond_1

    iget v1, v1, LRU0/b;->a:I

    iput v1, p0, LCR/c;->c:I

    invoke-static {v1}, Landroid/opengl/GLES20;->glUseProgram(I)V

    iget v1, p0, LCR/c;->c:I

    iget-object p1, p1, LER/c;->i:Ljava/lang/String;

    invoke-static {v1, p1}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result p1

    iput p1, p0, LCR/c;->a:I

    iget p0, p0, LCR/c;->c:I
    ...
    :cond_0
    const-string p0, "DimRenderProgram init fails."

.class public final Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl$a;->b:Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `setting_history` (`setting_item_id` TEXT NOT NULL, `last_updated_time` INTEGER NOT NULL, PRIMARY KEY(`setting_item_id`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v1, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'d5fb0cfaff00afd71700d141945e0fe7\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `setting_history`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;->o:I

    iget-object p0, p0, Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl$a;->b:Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl$a;->b:Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;

    sget v1, Lcom/linecorp/line/settings/search/data/SettingsSearchHistoryDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v4, "setting_item_id"
    ...
    const-string v0, "setting_item_id"
    ...
    const-string v4, "setting_history"
    ...
    const-string v0, "setting_history(com.linecorp.line.settings.search.data.entity.SettingHistory).\n Expected:\n"

.class public final Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl$a;->b:Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `keyword_history` (`keyword` TEXT NOT NULL, `last_updated_time` INTEGER NOT NULL, PRIMARY KEY(`keyword`))"

    const-string v0, "CREATE TABLE IF NOT EXISTS `mid_history` (`mid` TEXT NOT NULL, `mid_type` TEXT NOT NULL, `last_updated_time` INTEGER NOT NULL, PRIMARY KEY(`mid`, `mid_type`))"

    const-string v1, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v2, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'58ed275e4dec1c6182b6d7413244cba3\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `keyword_history`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "DROP TABLE IF EXISTS `mid_history`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;->o:I

    iget-object p0, p0, Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl$a;->b:Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl$a;->b:Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;

    sget v1, Lcom/linecorp/line/search/impl/repository/entry/history/db/SearchHistoryDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    invoke-static {p0, v0, v2, v1}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v5, "keyword_history"

    invoke-direct {v4, v5, p0, v2, v3}, Lk5/d;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    const-string v0, "keyword_history(com.linecorp.line.search.impl.model.entry.history.db.KeywordHistory).\n Expected:\n"
    ...
    const-string v9, "last_updated_time"
    ...
    const-string v5, "mid_history"

    invoke-direct {v4, v5, p0, v0, v2}, Lk5/d;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/AbstractSet;Ljava/util/AbstractSet;)V
    ...
    const-string v0, "mid_history(com.linecorp.line.search.impl.model.entry.history.db.MidHistory).\n Expected:\n"

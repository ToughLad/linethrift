.class public final Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl$a;
.super Lf5/s$a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;->h(Lf5/f;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
.end annotation
...
# instance fields
.field public final synthetic b:Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;
...
.method public constructor <init>(Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl$a;->b:Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `reaction_history` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `product_id` TEXT NOT NULL, `sticon_id` TEXT NOT NULL, `keyword` TEXT, `last_used_in_millis` INTEGER NOT NULL)"

    const-string v0, "CREATE UNIQUE INDEX IF NOT EXISTS `index_reaction_history_product_id_sticon_id` ON `reaction_history` (`product_id`, `sticon_id`)"

    const-string v1, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v2, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'f014941913c90c6194635e6687414d8e\')"
...
.method public final b(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `reaction_history`"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget p1, Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;->o:I

    iget-object p0, p0, Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl$a;->b:Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;
...
.method public final c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    sget v0, Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;->o:I
...
.method public final d(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl$a;->b:Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;

    sget v1, Lcom/linecorp/line/shopdata/common/db/ShopDatabase_Impl;->o:I
...
.method public final f(Landroidx/sqlite/db/SupportSQLiteDatabase;)Lf5/s$b;
    ...
    const-string v8, "last_used_in_millis"
    ...
    const-string v2, "last_used_in_millis"

    const/4 v3, 0x0

    invoke-static {p0, v2, v5, v3}, LQ5/O;->b(Ljava/util/HashMap;Ljava/lang/String;Lk5/d$a;I)Ljava/util/HashSet;
    ...
    const-string v7, "index_reaction_history_product_id_sticon_id"
    ...
    const-string v1, "reaction_history"
    ...
    const-string v1, "reaction_history(com.linecorp.line.shopdata.reaction.db.entity.ReactionHistoryEntity).\n Expected:\n"

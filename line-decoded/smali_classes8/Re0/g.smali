...
.method public constructor <init>(LAe0/l;)V
    ...
    invoke-direct {v0, p1, v1}, LRe0/e;-><init>(LAe0/l;Lkotlin/coroutines/Continuation;)V

    new-instance v1, LAT0/Y;

    const/16 v2, 0xb

    invoke-direct {v1, p1, v2}, LAT0/Y;-><init>(Ljava/lang/Object;I)V

    const-string v2, "searchExternalContactData"

    invoke-static {p1, v2}, Lkotlin/jvm/internal/n;->h(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LRe0/g;->a:LAe0/l;

    iput-object v0, p0, LRe0/g;->b:Lxk1/p;

    iput-object v1, p0, LRe0/g;->c:Lxk1/l;
...
.method public final a(Ljava/util/List;Lok1/d;)Ljava/io/Serializable;
    ...
    invoke-direct {v0, p0, p2}, LRe0/f;-><init>(LRe0/g;Lok1/d;)V

    :goto_0
    iget-object p2, v0, LRe0/f;->c:Ljava/lang/Object;

    sget-object v1, Lnk1/a;->COROUTINE_SUSPENDED:Lnk1/a;

    iget v2, v0, LRe0/f;->e:I
    ...
    iget-object p0, v0, LRe0/f;->b:LRe0/g;

    iget-object p1, v0, LRe0/f;->a:Ljava/util/List;
    ...
    iget-object p2, p0, LRe0/g;->c:Lxk1/l;
    ...
    iput-object p2, v0, LRe0/f;->a:Ljava/util/List;

    iput-object p0, v0, LRe0/f;->b:LRe0/g;

    iput v3, v0, LRe0/f;->e:I

    iget-object p2, p0, LRe0/g;->b:Lxk1/p;
    ...
    check-cast v2, Lcom/linecorp/line/search/api/model/SearchContactData;

    invoke-virtual {v2}, Lcom/linecorp/line/search/api/model/SearchContactData;->getMid()Ljava/lang/String;
    ...
    check-cast v0, Lcom/linecorp/line/search/api/model/SearchContactData;
    ...
    sget-object v4, Lcom/linecorp/line/search/impl/model/entry/history/db/MidType;->CONTACT:Lcom/linecorp/line/search/impl/model/entry/history/db/MidType;
    ...
    :cond_7
    new-instance p1, Lcom/linecorp/line/search/impl/model/entry/history/SearchHistoryItem$ContactItem;

    invoke-direct {p1, v0}, Lcom/linecorp/line/search/impl/model/entry/history/SearchHistoryItem$ContactItem;-><init>(Lcom/linecorp/line/search/api/model/SearchContactData;)V

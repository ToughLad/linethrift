.class public Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;->mDisplay:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;->mAdapted:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    sget-object p0, Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;->mDisplay:Ljava/util/Map;
    ...
    sget-object v0, Lio/card/payment/io/card/payment/i18n/StringKey;->CARDTYPE_MAESTRO:Lio/card/payment/io/card/payment/i18n/StringKey;
    ...
    const-string v1, "Hold card here.\nIt will scan automatically."
    ...
    const-string v1, "This device cannot use the camera to read card numbers."
    ...
    const-string v1, "Device camera is unavailable."
    ...
    const-string v1, "The device had an unexpected error opening the camera."
    ...
    const-string v1, "Modify Recognition Result"
    ...
    const-string v1, "Select the desired card number recognition result"
    ...
    const-string v1, "Select Card Number"
    ...
    const-string v1, "You can add numbers to the result by dragging the numbers at the bottom to the top.\nYou can also remove unnecessary numbers by dropping them to here."
...
.method public getAdaptedDisplay(Lio/card/payment/io/card/payment/i18n/StringKey;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2
    sget-object p2, Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;->mAdapted:Ljava/util/Map;
    ...
    sget-object p1, Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;->mAdapted:Ljava/util/Map;
...
.method public bridge synthetic getAdaptedDisplay(Ljava/lang/Enum;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2}, Lio/card/payment/io/card/payment/i18n/locales/LocalizedStringsEN;->getAdaptedDisplay(Lio/card/payment/io/card/payment/i18n/StringKey;Ljava/lang/String;)Ljava/lang/String;

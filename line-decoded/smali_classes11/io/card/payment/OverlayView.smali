...
.method static constructor <clinit>()V
    ...
    filled-new-array {v0, v1, v2, v3}, [Landroid/graphics/drawable/GradientDrawable$Orientation;
...
.method public constructor <init>(Lio/card/payment/CardIOActivity;Landroid/util/AttributeSet;Z)V
    ...
    invoke-direct {p3, v0, v0}, Lio/card/payment/Torch;-><init>(FF)V
    ...
    sget-object p1, Lio/card/payment/io/card/payment/i18n/StringKey;->SCAN_GUIDE:Lio/card/payment/io/card/payment/i18n/StringKey;
...
.method private decorateBitmap()V
    ...
    iget-object p0, p0, Lio/card/payment/OverlayView;->mBitmap:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1, v2, p0, p0, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
...
.method private guideStrokeRect(IIII)Landroid/graphics/Rect;
    ...
    iget p0, p0, Lio/card/payment/OverlayView;->mScale:F
...
.method public getCardImage()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v2, v2, v1, p0}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
...
.method public getTorchRect()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, Lio/card/payment/OverlayView;->mTorchRect:Landroid/graphics/Rect;
...
.method public isAnimating()Z
    ...
    iget p0, p0, Lio/card/payment/OverlayView;->mState:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lio/card/payment/OverlayView;->mLockedBackgroundPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    :cond_3
    iget-object v0, p0, Lio/card/payment/OverlayView;->mGuidePaint:Landroid/graphics/Paint;
    ...
    iget v1, p0, Lio/card/payment/OverlayView;->guideColor:I
    ...
    invoke-direct {p0, v1, v0, v3, v0}, Lio/card/payment/OverlayView;->guideStrokeRect(IIII)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v1, v0, v1, v3}, Lio/card/payment/OverlayView;->guideStrokeRect(IIII)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v1, v0, v1, v2}, Lio/card/payment/OverlayView;->guideStrokeRect(IIII)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v1, v2, v0, v2}, Lio/card/payment/OverlayView;->guideStrokeRect(IIII)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v1, v2, v1, v0}, Lio/card/payment/OverlayView;->guideStrokeRect(IIII)Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Lio/card/payment/OverlayView;->mGuidePaint:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Lio/card/payment/OverlayView;->mTorch:Lio/card/payment/Torch;

    invoke-virtual {p0, p1}, Lio/card/payment/Torch;->draw(Landroid/graphics/Canvas;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object p0, p0, Lio/card/payment/OverlayView;->mScanActivityRef:Ljava/lang/ref/WeakReference;

    invoke-virtual {p0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lio/card/payment/CardIOActivity;

    invoke-virtual {p0}, Lio/card/payment/CardIOActivity;->toggleFlash()V
    ...
    invoke-virtual {p0}, Lio/card/payment/CardIOActivity;->triggerAutoFocus()V
    :try_end_0
...
.method public setGuideAndRotation(Landroid/graphics/Rect;I)V
    ...
    invoke-static {v0, v1, v1}, Lio/card/payment/Util;->rectGivenCenter(Landroid/graphics/Point;II)Landroid/graphics/Rect;
    ...
    iget-object p0, p0, Lio/card/payment/OverlayView;->mGuide:Landroid/graphics/Rect;
    ...
    invoke-virtual {p1, p2, p0}, Landroid/graphics/Path;->addRect(Landroid/graphics/RectF;Landroid/graphics/Path$Direction;)V
...
.method public setUseCardIOLogo()V
    .locals 1

    iget-object p0, p0, Lio/card/payment/OverlayView;->mLogo:Lio/card/payment/Logo;

    sget-object v0, Lio/card/payment/Logo$TYPE;->CARD_IO:Lio/card/payment/Logo$TYPE;

    invoke-virtual {p0, v0}, Lio/card/payment/Logo;->loadLogo(Lio/card/payment/Logo$TYPE;)V

    return-void
.end method

.method public setUseLineLogo()V
    .locals 1

    iget-object p0, p0, Lio/card/payment/OverlayView;->mLogo:Lio/card/payment/Logo;

    sget-object v0, Lio/card/payment/Logo$TYPE;->LINE:Lio/card/payment/Logo$TYPE;
...
.method public setUsePaypalLogo()V
    .locals 1

    iget-object p0, p0, Lio/card/payment/OverlayView;->mLogo:Lio/card/payment/Logo;

    sget-object v0, Lio/card/payment/Logo$TYPE;->PAYPAL:Lio/card/payment/Logo$TYPE;

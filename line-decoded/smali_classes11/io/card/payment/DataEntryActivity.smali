...
.method public static bridge synthetic a(Lio/card/payment/DataEntryActivity;)V
    .locals 0
...
.method private addCardholderNameIfNeeded(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v0, v2, v1, v2, v2}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v4, Lio/card/payment/io/card/payment/ui/Appearance;->TEXT_COLOR_LABEL:I
    ...
    invoke-static {v3, v4, v2, v2, v2}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    sget-object v2, Lio/card/payment/io/card/payment/i18n/StringKey;->ENTRY_CARDHOLDER_NAME:Lio/card/payment/io/card/payment/i18n/StringKey;

    invoke-static {v2}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->getString(Lio/card/payment/io/card/payment/i18n/StringKey;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lio/card/payment/DataEntryActivity;->cardholderNameEdit:Landroid/widget/EditText;
...
.method private completed()V
    ...
    iget v2, v1, Lio/card/payment/ExpiryValidator;->month:I
    ...
    :cond_1
    new-instance v2, Lio/card/payment/CreditCard;
    ...
    :cond_2
    sget v1, Lio/card/payment/CardIOActivity;->RESULT_CARD_INFO:I
...
.method private setDefaultColor(Landroid/widget/EditText;)V
    ...
    iget p0, p0, Lio/card/payment/DataEntryActivity;->defaultTextColor:I
...
.method public afterTextChanged(Landroid/text/Editable;)V
    ...
    sget v0, Lio/card/payment/io/card/payment/ui/Appearance;->TEXT_COLOR_ERROR:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v0, v4}, Lio/card/payment/io/card/payment/ui/ActivityHelper;->setActivityTheme(Landroid/app/Activity;Z)V
    ...
    invoke-static {}, Lio/card/payment/io/card/payment/ui/ActivityHelper;->holoSupported()Z
    ...
    invoke-static {v4}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->setLanguage(Landroid/content/Intent;)V

    const-string v4, "4dip"

    invoke-static {v4, v0}, Lio/card/payment/io/card/payment/ui/ViewUtil;->typedDimensionValueToPixelsInt(Ljava/lang/String;Landroid/content/Context;)I
    ...
    sget v7, Lio/card/payment/io/card/payment/ui/Appearance;->DEFAULT_BACKGROUND_COLOR:I
    ...
    iget v8, v0, Lio/card/payment/DataEntryActivity;->viewIdCounter:I
    ...
    invoke-virtual {v7, v11, v9, v9}, Landroid/view/ViewGroup;->addView(Landroid/view/View;II)V
    ...
    const-string v14, "io.card.payment.scanResult"

    invoke-virtual {v13, v14}, Landroid/content/Intent;->getParcelableExtra(Ljava/lang/String;)Landroid/os/Parcelable;

    move-result-object v13

    check-cast v13, Lio/card/payment/CreditCard;

    iput-object v13, v0, Lio/card/payment/DataEntryActivity;->capture:Lio/card/payment/CreditCard;

    invoke-virtual {v0}, Landroid/app/Activity;->getIntent()Landroid/content/Intent;

    move-result-object v13

    const-string v14, "debug_autoAcceptResult"

    invoke-virtual {v13, v14, v2}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v13

    iput-boolean v13, v0, Lio/card/payment/DataEntryActivity;->autoAcceptDone:Z

    iget-object v13, v0, Lio/card/payment/DataEntryActivity;->capture:Lio/card/payment/CreditCard;
    ...
    new-instance v3, Lio/card/payment/CardNumberValidator;

    iget-object v13, v13, Lio/card/payment/CreditCard;->cardNumber:Ljava/lang/String;

    invoke-direct {v3, v13}, Lio/card/payment/CardNumberValidator;-><init>(Ljava/lang/String;)V

    iput-object v3, v0, Lio/card/payment/DataEntryActivity;->numberValidator:Lio/card/payment/Validator;

    new-instance v3, Landroid/widget/ImageView;

    invoke-direct {v3, v0}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object v3, v0, Lio/card/payment/DataEntryActivity;->cardView:Landroid/widget/ImageView;

    new-instance v3, Landroid/widget/LinearLayout$LayoutParams;

    invoke-direct {v3, v9, v10}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    iget-object v13, v0, Lio/card/payment/DataEntryActivity;->cardView:Landroid/widget/ImageView;

    invoke-virtual {v13, v2, v2, v2, v5}, Landroid/view/View;->setPadding(IIII)V
    ...
    iget-object v3, v0, Lio/card/payment/DataEntryActivity;->cardView:Landroid/widget/ImageView;

    invoke-static {v3, v14, v14, v14, v1}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v3, v0, Lio/card/payment/DataEntryActivity;->activityTitleTextView:Landroid/widget/TextView;
    ...
    iget-object v3, v0, Lio/card/payment/DataEntryActivity;->activityTitleTextView:Landroid/widget/TextView;

    sget v13, Lio/card/payment/io/card/payment/ui/Appearance;->PAY_BLUE_COLOR:I
    ...
    invoke-static {v3, v14, v14, v14, v1}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, v0, Lio/card/payment/DataEntryActivity;->activityTitleTextView:Landroid/widget/TextView;

    invoke-static {v3, v10, v10}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setDimensions(Landroid/view/View;II)V
    ...
    invoke-static {v3, v14, v4, v14, v4}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v13, v15, v14, v14, v14}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    sget-object v15, Lio/card/payment/io/card/payment/i18n/StringKey;->ENTRY_CARD_NUMBER:Lio/card/payment/io/card/payment/i18n/StringKey;

    invoke-static {v15}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->getString(Lio/card/payment/io/card/payment/i18n/StringKey;)Ljava/lang/String;
    ...
    sget v15, Lio/card/payment/io/card/payment/ui/Appearance;->TEXT_COLOR_LABEL:I

    invoke-virtual {v13, v15}, Landroid/widget/TextView;->setTextColor(I)V

    :cond_5
    invoke-virtual {v3, v13, v10, v10}, Landroid/view/ViewGroup;->addView(Landroid/view/View;II)V

    new-instance v13, Landroid/widget/EditText;

    invoke-direct {v13, v0}, Landroid/widget/EditText;-><init>(Landroid/content/Context;)V

    iput-object v13, v0, Lio/card/payment/DataEntryActivity;->numberEdit:Landroid/widget/EditText;
    ...
    iget-object v2, v0, Lio/card/payment/DataEntryActivity;->numberEdit:Landroid/widget/EditText;
    ...
    invoke-virtual {v2, v13, v14}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-virtual {v2, v13}, Landroid/widget/TextView;->setHintTextColor(I)V

    :cond_6
    new-instance v2, Lio/card/payment/CardNumberValidator;

    invoke-direct {v2}, Lio/card/payment/CardNumberValidator;-><init>()V

    iput-object v2, v0, Lio/card/payment/DataEntryActivity;->numberValidator:Lio/card/payment/Validator;
    ...
    new-array v9, v15, [Landroid/text/InputFilter;
    ...
    invoke-virtual {v2, v9}, Landroid/widget/TextView;->setFilters([Landroid/text/InputFilter;)V

    iget-object v2, v0, Lio/card/payment/DataEntryActivity;->numberEdit:Landroid/widget/EditText;

    const/4 v9, -0x1

    invoke-virtual {v3, v2, v9, v10}, Landroid/view/ViewGroup;->addView(Landroid/view/View;II)V
    ...
    invoke-static {v2, v9, v4, v9, v4}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v14, v9}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z
    ...
    const-string v10, "io.card.payment.requirePostalCode"

    invoke-virtual {v15, v10, v9}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z
    ...
    invoke-direct {v10, v9, v13, v14}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
    ...
    iget-boolean v13, v0, Lio/card/payment/DataEntryActivity;->useApplicationTheme:Z

    if-nez v13, :cond_7

    sget v13, Lio/card/payment/io/card/payment/ui/Appearance;->TEXT_COLOR_LABEL:I

    invoke-virtual {v9, v13}, Landroid/widget/TextView;->setTextColor(I)V

    :cond_7
    sget-object v13, Lio/card/payment/io/card/payment/i18n/StringKey;->ENTRY_EXPIRES:Lio/card/payment/io/card/payment/i18n/StringKey;

    invoke-static {v13}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->getString(Lio/card/payment/io/card/payment/i18n/StringKey;)Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v9, v13}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v13, v0, Lio/card/payment/DataEntryActivity;->labelLeftPadding:Ljava/lang/String;

    const/4 v14, 0x0

    invoke-static {v9, v13, v14, v14, v14}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const/4 v13, -0x2

    invoke-virtual {v15, v9, v13, v13}, Landroid/view/ViewGroup;->addView(Landroid/view/View;II)V

    new-instance v9, Landroid/widget/EditText;

    invoke-direct {v9, v0}, Landroid/widget/EditText;-><init>(Landroid/content/Context;)V

    iput-object v9, v0, Lio/card/payment/DataEntryActivity;->expiryEdit:Landroid/widget/EditText;

    iget v13, v0, Lio/card/payment/DataEntryActivity;->editTextIdCounter:I
    ...
    iget-object v9, v0, Lio/card/payment/DataEntryActivity;->expiryEdit:Landroid/widget/EditText;
    ...
    invoke-virtual {v9, v13}, Landroid/widget/TextView;->setInputType(I)V

    iget-object v9, v0, Lio/card/payment/DataEntryActivity;->expiryEdit:Landroid/widget/EditText;

    sget-object v13, Lio/card/payment/io/card/payment/i18n/StringKey;->EXPIRES_PLACEHOLDER:Lio/card/payment/io/card/payment/i18n/StringKey;
    ...
    invoke-virtual {v9, v13}, Landroid/widget/TextView;->setHintTextColor(I)V
    ...
    new-instance v13, Lio/card/payment/ExpiryValidator;

    iget v14, v9, Lio/card/payment/CreditCard;->expiryMonth:I

    iget v9, v9, Lio/card/payment/CreditCard;->expiryYear:I

    invoke-direct {v13, v14, v9}, Lio/card/payment/ExpiryValidator;-><init>(II)V

    iput-object v13, v0, Lio/card/payment/DataEntryActivity;->expiryValidator:Lio/card/payment/Validator;

    goto :goto_2

    :cond_9
    new-instance v9, Lio/card/payment/ExpiryValidator;

    invoke-direct {v9}, Lio/card/payment/ExpiryValidator;-><init>()V

    iput-object v9, v0, Lio/card/payment/DataEntryActivity;->expiryValidator:Lio/card/payment/Validator;

    :goto_2
    iget-object v9, v0, Lio/card/payment/DataEntryActivity;->expiryValidator:Lio/card/payment/Validator;

    invoke-interface {v9}, Lio/card/payment/Validator;->hasFullLength()Z
    ...
    iget-object v13, v0, Lio/card/payment/DataEntryActivity;->expiryValidator:Lio/card/payment/Validator;

    invoke-interface {v13}, Lio/card/payment/Validator;->getValue()Ljava/lang/String;
    ...
    invoke-virtual {v9, v13}, Landroid/widget/TextView;->addTextChangedListener(Landroid/text/TextWatcher;)V
    ...
    new-instance v13, Landroid/text/method/DateKeyListener;

    invoke-direct {v13}, Landroid/text/method/DateKeyListener;-><init>()V

    iget-object v14, v0, Lio/card/payment/DataEntryActivity;->expiryValidator:Lio/card/payment/Validator;
    ...
    invoke-virtual {v9, v14}, Landroid/widget/TextView;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-virtual {v15, v9, v13, v14}, Landroid/view/ViewGroup;->addView(Landroid/view/View;II)V
    ...
    :goto_5
    invoke-static {v15, v14, v14, v9, v14}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v9, Lio/card/payment/AlwaysValid;

    invoke-direct {v9}, Lio/card/payment/AlwaysValid;-><init>()V
    ...
    invoke-direct {v10, v15, v13, v14}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
    ...
    sget v14, Lio/card/payment/io/card/payment/ui/Appearance;->TEXT_COLOR_LABEL:I
    ...
    invoke-static {v13, v14, v15, v15, v15}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    sget-object v14, Lio/card/payment/io/card/payment/i18n/StringKey;->ENTRY_CVV:Lio/card/payment/io/card/payment/i18n/StringKey;

    invoke-static {v14}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->getString(Lio/card/payment/io/card/payment/i18n/StringKey;)Ljava/lang/String;
    ...
    iput-object v13, v0, Lio/card/payment/DataEntryActivity;->cvvEdit:Landroid/widget/EditText;
    ...
    iget-object v13, v0, Lio/card/payment/DataEntryActivity;->cvvEdit:Landroid/widget/EditText;
    ...
    invoke-static {v13}, Lio/card/payment/CardType;->fromCardNumber(Ljava/lang/String;)Lio/card/payment/CardType;

    move-result-object v13

    invoke-virtual {v13}, Lio/card/payment/CardType;->cvvLength()I
    ...
    invoke-direct {v14, v13}, Lio/card/payment/FixedLengthValidator;-><init>(I)V
    ...
    iget-object v15, v0, Lio/card/payment/DataEntryActivity;->cvvValidator:Lio/card/payment/Validator;
    ...
    invoke-virtual {v9, v13, v14, v15}, Landroid/view/ViewGroup;->addView(Landroid/view/View;II)V
    ...
    :goto_a
    invoke-static {v9, v10, v14, v13, v14}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v14, Lio/card/payment/io/card/payment/i18n/StringKey;->ENTRY_POSTAL_CODE:Lio/card/payment/io/card/payment/i18n/StringKey;
    ...
    const-string v14, "io.card.payment.restrictPostalCodeToNumericOnly"
    ...
    iput-object v14, v0, Lio/card/payment/DataEntryActivity;->postalCodeEdit:Landroid/widget/EditText;
    ...
    iget-object v13, v0, Lio/card/payment/DataEntryActivity;->postalCodeEdit:Landroid/widget/EditText;
    ...
    :cond_16
    new-instance v13, Lio/card/payment/MaxLengthValidator;

    const/16 v14, 0x14

    invoke-direct {v13, v14}, Lio/card/payment/MaxLengthValidator;-><init>(I)V

    iput-object v13, v0, Lio/card/payment/DataEntryActivity;->postalCodeValidator:Lio/card/payment/Validator;

    iget-object v14, v0, Lio/card/payment/DataEntryActivity;->postalCodeEdit:Landroid/widget/EditText;
    ...
    :goto_10
    invoke-static {v9, v10, v14, v14, v14}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v9, v0, Lio/card/payment/DataEntryActivity;->postalCodeValidator:Lio/card/payment/Validator;

    :goto_11
    invoke-virtual {v7, v2, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    invoke-direct {v0, v7}, Lio/card/payment/DataEntryActivity;->addCardholderNameIfNeeded(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v7, v2, v3, v2, v3}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v15, v5}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    new-instance v5, Landroid/widget/Button;

    invoke-direct {v5, v0}, Landroid/widget/Button;-><init>(Landroid/content/Context;)V

    iput-object v5, v0, Lio/card/payment/DataEntryActivity;->doneBtn:Landroid/widget/Button;

    new-instance v5, Landroid/widget/LinearLayout$LayoutParams;

    const/high16 v7, 0x3f800000    # 1.0f

    invoke-direct {v5, v13, v14, v7}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V

    iget-object v7, v0, Lio/card/payment/DataEntryActivity;->doneBtn:Landroid/widget/Button;

    sget-object v8, Lio/card/payment/io/card/payment/i18n/StringKey;->DONE:Lio/card/payment/io/card/payment/i18n/StringKey;

    invoke-static {v8}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->getString(Lio/card/payment/io/card/payment/i18n/StringKey;)Ljava/lang/String;
    ...
    new-instance v8, Lio/card/payment/DataEntryActivity$1;

    invoke-direct {v8, v0}, Lio/card/payment/DataEntryActivity$1;-><init>(Lio/card/payment/DataEntryActivity;)V
    ...
    invoke-static {v5, v13, v0, v7}, Lio/card/payment/io/card/payment/ui/ViewUtil;->styleAsButton(Landroid/widget/Button;ZLandroid/content/Context;Z)V
    ...
    invoke-static {v5, v7, v14, v7, v14}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setPadding(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v5, v0, Lio/card/payment/DataEntryActivity;->doneBtn:Landroid/widget/Button;

    invoke-static {v5, v1, v1, v1, v1}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v5, v0, Lio/card/payment/DataEntryActivity;->cancelBtn:Landroid/widget/Button;
    ...
    invoke-direct {v5, v13, v14, v9}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V

    iget-object v9, v0, Lio/card/payment/DataEntryActivity;->cancelBtn:Landroid/widget/Button;

    sget-object v10, Lio/card/payment/io/card/payment/i18n/StringKey;->CANCEL:Lio/card/payment/io/card/payment/i18n/StringKey;

    invoke-static {v10}, Lio/card/payment/io/card/payment/i18n/LocalizedStrings;->getString(Lio/card/payment/io/card/payment/i18n/StringKey;)Ljava/lang/String;
    ...
    new-instance v10, Lio/card/payment/DataEntryActivity$2;

    invoke-direct {v10, v0}, Lio/card/payment/DataEntryActivity$2;-><init>(Lio/card/payment/DataEntryActivity;)V
    ...
    iget-object v5, v0, Lio/card/payment/DataEntryActivity;->cancelBtn:Landroid/widget/Button;

    iget-boolean v9, v0, Lio/card/payment/DataEntryActivity;->useApplicationTheme:Z

    const/4 v15, 0x0

    invoke-static {v5, v15, v0, v9}, Lio/card/payment/io/card/payment/ui/ViewUtil;->styleAsButton(Landroid/widget/Button;ZLandroid/content/Context;Z)V
    ...
    invoke-static {v5, v4, v1, v1, v1}, Lio/card/payment/io/card/payment/ui/ViewUtil;->setMargins(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lio/card/payment/io/card/payment/ui/ActivityHelper;->addActionBarIfSupported(Landroid/app/Activity;)V
    ...
    invoke-virtual {v1, v2, v15}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z
    ...
    sget-object v2, Lio/card/payment/io/card/payment/i18n/StringKey;->MANUAL_ENTRY_TITLE:Lio/card/payment/io/card/payment/i18n/StringKey;
    ...
    invoke-static {v0, v1, v2, v3, v14}, Lio/card/payment/io/card/payment/ui/ActivityHelper;->setupActionBarIfSupported(Landroid/app/Activity;Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V

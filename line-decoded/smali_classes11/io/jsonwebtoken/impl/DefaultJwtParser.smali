...
.method public parse(Ljava/lang/String;)Lio/jsonwebtoken/Jwt;
    ...
    .line 14
    iget-object v1, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->base64UrlDecoder:Lio/jsonwebtoken/io/Decoder;

    invoke-interface {v1, v10}, Lio/jsonwebtoken/io/Decoder;->decode(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v1}, Lio/jsonwebtoken/impl/DefaultJwsHeader;-><init>(Ljava/util/Map;)V
    ...
    invoke-direct {v3, v1}, Lio/jsonwebtoken/impl/DefaultHeader;-><init>(Ljava/util/Map;)V

    .line 19
    :goto_5
    iget-object v1, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->compressionCodecResolver:Lio/jsonwebtoken/CompressionCodecResolver;

    invoke-interface {v1, v3}, Lio/jsonwebtoken/CompressionCodecResolver;->resolveCompressionCodec(Lio/jsonwebtoken/Header;)Lio/jsonwebtoken/CompressionCodec;
    ...
    .line 20
    :goto_6
    iget-object v4, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->base64UrlDecoder:Lio/jsonwebtoken/io/Decoder;
    ...
    .line 21
    invoke-interface {v1, v4}, Lio/jsonwebtoken/CompressionCodec;->decompress([B)[B
    ...
    .line 24
    invoke-virtual {v0, v1}, Lio/jsonwebtoken/impl/DefaultJwtParser;->readValue(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 31
    iget-object v8, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->key:Ljava/security/Key;
    ...
    .line 41
    :cond_11
    invoke-interface {v14, v4, v1}, Lio/jsonwebtoken/SigningKeyResolver;->resolveSigningKey(Lio/jsonwebtoken/JwsHeader;Ljava/lang/String;)Ljava/security/Key;
    ...
    .line 48
    invoke-virtual {v0, v5, v8}, Lio/jsonwebtoken/impl/DefaultJwtParser;->createSignatureValidator(Lio/jsonwebtoken/SignatureAlgorithm;Ljava/security/Key;)Lio/jsonwebtoken/impl/crypto/JwtSignatureValidator;
    ...
    .line 63
    iget-wide v6, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->allowedClockSkewMillis:J
    ...
    .line 70
    invoke-static {v4, v1, v14, v2, v13}, Lc;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 72
    invoke-static {v4, v5, v10, v1}, LDV0/l;->a(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-direct {v1, v3, v5, v0}, Lio/jsonwebtoken/ExpiredJwtException;-><init>(Lio/jsonwebtoken/Header;Lio/jsonwebtoken/Claims;Ljava/lang/String;)V
    ...
    .line 75
    iget-wide v7, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->allowedClockSkewMillis:J
    ...
    .line 84
    invoke-static {v6, v7, v10, v1}, LDV0/l;->a(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-direct {v1, v3, v5, v0}, Lio/jsonwebtoken/PrematureJwtException;-><init>(Lio/jsonwebtoken/Header;Lio/jsonwebtoken/Claims;Ljava/lang/String;)V
    ...
    :cond_1d
    :goto_10
    invoke-direct {v0, v3, v5}, Lio/jsonwebtoken/impl/DefaultJwtParser;->validateExpectedClaims(Lio/jsonwebtoken/Header;Lio/jsonwebtoken/Claims;)V
    ...
    invoke-direct {v0, v3, v1, v2}, Lio/jsonwebtoken/impl/DefaultJws;-><init>(Lio/jsonwebtoken/JwsHeader;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3, v1}, Lio/jsonwebtoken/impl/DefaultJwt;-><init>(Lio/jsonwebtoken/Header;Ljava/lang/Object;)V
    ...
    .line 93
    invoke-static {v8, v0}, LL/e;->a(ILjava/lang/String;)Ljava/lang/String;

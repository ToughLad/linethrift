...
.method public constructor <init>(Lio/sentry/android/replay/capture/a;Lio/sentry/android/replay/capture/a;)V
    ...
    iput-object p1, p0, Lio/sentry/android/replay/capture/j;->b:Lio/sentry/android/replay/capture/a;

    iput-object p2, p0, Lio/sentry/android/replay/capture/j;->c:Lio/sentry/android/replay/capture/a;
    ...
    iput-object p1, p0, Lio/sentry/android/replay/capture/j;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final a(LEk1/m;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/sentry/android/replay/capture/j;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance p2, Lio/sentry/android/replay/capture/j$a;

    iget-object v0, p0, Lio/sentry/android/replay/capture/j;->c:Lio/sentry/android/replay/capture/a;

    invoke-direct {p2, p1, p3, v0}, Lio/sentry/android/replay/capture/j$a;-><init>(Ljava/lang/Object;Ljava/lang/Object;Lio/sentry/android/replay/capture/a;)V

    iget-object p0, p0, Lio/sentry/android/replay/capture/j;->b:Lio/sentry/android/replay/capture/a;
    ...
    new-instance p1, LTl1/g;

    const/4 v0, 0x1

    invoke-direct {p1, p2, v0}, LTl1/g;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p2}, Lio/sentry/android/replay/capture/j$a;->invoke()Ljava/lang/Object;
    :try_end_0

...
.method public final e(Lio/sentry/Z1;)V
    ...
    iput-object v0, p0, Lio/sentry/UncaughtExceptionHandlerIntegration;->b:Lio/sentry/i1;

    iput-object p1, p0, Lio/sentry/UncaughtExceptionHandlerIntegration;->c:Lio/sentry/Z1;
    ...
    invoke-virtual {v1}, Lio/sentry/Z1;->isEnableUncaughtExceptionHandler()Z
    ...
    invoke-interface {p1, v0, v3, v1}, Lio/sentry/ILogger;->f(Lio/sentry/T1;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v1, v0, v3, v4}, Lio/sentry/ILogger;->f(Lio/sentry/T1;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {p0, v0, p1, v1}, Lio/sentry/ILogger;->f(Lio/sentry/T1;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lio/sentry/UncaughtExceptionHandlerIntegration;->b:Lio/sentry/i1;
    ...
    invoke-direct {v3, v1, p2, p1, v2}, Lio/sentry/exception/a;-><init>(Lio/sentry/protocol/i;Ljava/lang/Throwable;Ljava/lang/Thread;Z)V

    new-instance v1, Lio/sentry/N1;

    invoke-direct {v1, v3}, Lio/sentry/N1;-><init>(Ljava/lang/Throwable;)V

    sget-object v3, Lio/sentry/T1;->FATAL:Lio/sentry/T1;

    iput-object v3, v1, Lio/sentry/N1;->x:Lio/sentry/T1;

    iget-object v3, p0, Lio/sentry/UncaughtExceptionHandlerIntegration;->b:Lio/sentry/i1;

    invoke-virtual {v3}, Lio/sentry/i1;->g()Lio/sentry/Z;

    move-result-object v3

    if-nez v3, :cond_0

    iget-object v3, v1, Lio/sentry/o1;->a:Lio/sentry/protocol/q;

    if-eqz v3, :cond_0

    invoke-virtual {v0, v3}, Lio/sentry/UncaughtExceptionHandlerIntegration$a;->g(Lio/sentry/protocol/q;)V
    ...
    iget-object v4, p0, Lio/sentry/UncaughtExceptionHandlerIntegration;->b:Lio/sentry/i1;

    invoke-virtual {v4, v1, v3}, Lio/sentry/i1;->B(Lio/sentry/N1;Lio/sentry/B;)Lio/sentry/protocol/q;
    ...
    invoke-virtual {v3, v6, v5}, Lio/sentry/B;->b(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v1, v1, Lio/sentry/o1;->a:Lio/sentry/protocol/q;

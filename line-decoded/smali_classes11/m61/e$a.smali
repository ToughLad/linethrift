...
# instance fields
.field public final f:LBn/d;

.field public final g:LO61/b;

.field public final h:LO61/d;

.field public final i:LG51/f0;
...
.method public constructor <init>(LN11/d;Landroid/widget/ImageView;Lxk1/l;)V
    ...
    invoke-direct {p1, p2, v0}, LBn/d;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, Lm61/e$a;->f:LBn/d;

    new-instance p1, LO61/b;

    const/4 v0, 0x3

    invoke-direct {p1, p2, v0}, LO61/b;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, Lm61/e$a;->g:LO61/b;

    new-instance p1, LO61/d;

    const/4 v0, 0x2

    invoke-direct {p1, p2, v0}, LO61/d;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, Lm61/e$a;->h:LO61/d;

    new-instance p1, LG51/f0;

    const/4 v0, 0x3

    invoke-direct {p1, p2, v0}, LG51/f0;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, Lm61/e$a;->i:LG51/f0;
    ...
    invoke-direct {p1, p0, p3}, LIV/a;-><init>(Lm61/e$a;Lxk1/l;)V
...
.method public final l(Lb51/f;)V
    ...
    iget-object v0, p0, Lm61/e$a;->j:Lb51/f;
    ...
    iget-object v0, p0, Lm61/e$a;->k:Landroidx/lifecycle/O;

    iget-object v1, p0, Lm61/e$a;->f:LBn/d;
    ...
    iput-object v0, p0, Lm61/e$a;->k:Landroidx/lifecycle/O;

    iget-object v2, p0, Lm61/e$a;->l:Landroidx/lifecycle/O;

    iget-object v3, p0, Lm61/e$a;->g:LO61/b;
    ...
    :cond_1
    iput-object v0, p0, Lm61/e$a;->l:Landroidx/lifecycle/O;

    iget-object v2, p0, Lm61/e$a;->m:Landroidx/lifecycle/O;

    iget-object v4, p0, Lm61/e$a;->h:LO61/d;
    ...
    :cond_2
    iput-object v0, p0, Lm61/e$a;->m:Landroidx/lifecycle/O;

    iget-object v2, p0, Lm61/e$a;->n:Landroidx/lifecycle/O;

    iget-object v5, p0, Lm61/e$a;->i:LG51/f0;
    ...
    :cond_3
    iput-object v0, p0, Lm61/e$a;->n:Landroidx/lifecycle/O;

    iput-object p1, p0, Lm61/e$a;->j:Lb51/f;
    ...
    iget-object v7, p0, Lm61/e$a;->k:Landroidx/lifecycle/O;
    ...
    :cond_4
    iput-object v6, p0, Lm61/e$a;->k:Landroidx/lifecycle/O;
    ...
    iget-object v1, p0, Lm61/e$a;->l:Landroidx/lifecycle/O;
    ...
    iget-object v3, p0, Lm61/e$a;->m:Landroidx/lifecycle/O;
    ...
    :cond_6
    iput-object v1, p0, Lm61/e$a;->m:Landroidx/lifecycle/O;
    ...
    :cond_7
    iget-object v1, p0, Lm61/e$a;->n:Landroidx/lifecycle/O;

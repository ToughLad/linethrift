...
.method public constructor <init>(LB11/d$a;Landroid/widget/FrameLayout;)V
    ...
    new-instance v3, LQ01/b0;

    move-object v4, p2

    check-cast v4, Landroidx/constraintlayout/widget/ConstraintLayout;

    invoke-direct/range {v3 .. v12}, LQ01/b0;-><init>(Landroidx/constraintlayout/widget/ConstraintLayout;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroidx/constraintlayout/widget/Guideline;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object v3, p0, Lm61/e;->f:LQ01/b0;

    new-instance p2, Lm61/e$b;
    ...
    invoke-direct/range {v3 .. v10}, LHx/p;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-direct {p2, p1, v3}, Lm61/e$b;-><init>(LB11/d$a;LHx/p;)V

    iput-object p2, v5, Lm61/e;->g:Lm61/e$b;
    ...
    iput-object p0, v5, Lm61/e;->h:Ly11/l;

    new-instance v0, LO61/a;

    const/4 v1, 0x4

    invoke-direct {v0, v5, v1}, LO61/a;-><init>(Ljava/lang/Object;I)V

    iput-object v0, v5, Lm61/e;->i:LO61/a;

    new-instance v0, LBn/b;

    const/4 v1, 0x5

    invoke-direct {v0, v5, v1}, LBn/b;-><init>(Ljava/lang/Object;I)V

    new-instance v1, LBn/c;

    const/4 v3, 0x5

    invoke-direct {v1, v5, v3}, LBn/c;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object p0, v5, Lm61/e;->j:Landroidx/lifecycle/O;
    ...
    invoke-virtual {v12, p0}, Landroid/view/View;->setClipToOutline(Z)V

    new-instance p0, Landroidx/recyclerview/widget/LinearLayoutManager;

    invoke-direct {p0, v2}, Landroidx/recyclerview/widget/LinearLayoutManager;-><init>(I)V

    invoke-virtual {v12, p0}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$n;)V

    invoke-virtual {v12, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Landroidx/recyclerview/widget/RecyclerView$f;)V
    ...
    invoke-virtual {v12, p0}, Landroidx/recyclerview/widget/RecyclerView;->j(Landroidx/recyclerview/widget/RecyclerView$m;)V

    const/4 p0, 0x2

    invoke-virtual {v12, p0}, Landroid/view/View;->setOverScrollMode(I)V
...
.method public static final l(Lm61/e;Lb51/f;)V
    .locals 3

    iget-object v0, p0, Lm61/e;->k:Lb51/e;

    invoke-static {p1, v0}, Lkotlin/jvm/internal/n;->c(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    iget-object v1, p0, Lm61/e;->h:Ly11/l;

    const/4 v2, 0x0

    if-eqz v0, :cond_0

    iput-object v2, p0, Lm61/e;->k:Lb51/e;

    invoke-virtual {p0, v1}, Lm61/e;->m(Landroidx/lifecycle/O;)V
    ...
    iput-object v0, p0, Lm61/e;->k:Lb51/e;

    invoke-interface {v0}, Lb51/e;->e()Landroidx/lifecycle/O;

    move-result-object v0

    invoke-virtual {p0, v0}, Lm61/e;->m(Landroidx/lifecycle/O;)V
    ...
    iput-object v1, p0, Lm61/e;->k:Lb51/e;
...
.method public final j(I)V
    ...
    iput-object p1, p0, Lm61/e;->k:Lb51/e;

    iget-object p1, p0, Lm61/e;->h:Ly11/l;

    invoke-virtual {p0, p1}, Lm61/e;->m(Landroidx/lifecycle/O;)V
...
.method public final m(Landroidx/lifecycle/O;)V
    ...
    iget-object v0, p0, Lm61/e;->j:Landroidx/lifecycle/O;

    iget-object v1, p0, Lm61/e;->i:LO61/a;

    invoke-virtual {v0, v1}, Landroidx/lifecycle/O;->p(Landroidx/lifecycle/U;)V

    iput-object p1, p0, Lm61/e;->j:Landroidx/lifecycle/O;
...
.method public final n(Landroid/widget/ImageView;Lb51/f;)V
    ...
    :cond_1
    check-cast v1, Lm61/e$a;

    if-nez v1, :cond_2

    new-instance v1, Lm61/e$a;

    new-instance v2, LVc0/f;
    ...
    invoke-direct/range {v2 .. v9}, LVc0/f;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    iget-object p0, v4, LN11/f;->a:LN11/d;

    invoke-direct {v1, p0, p1, v2}, Lm61/e$a;-><init>(LN11/d;Landroid/widget/ImageView;Lxk1/l;)V

    invoke-virtual {v1}, LN11/f;->k()V

    :cond_2
    invoke-virtual {v1, p2}, Lm61/e$a;->l(Lb51/f;)V
    ...
    :goto_2
    check-cast p0, Lm61/e$a;

    if-eqz p0, :cond_6

    invoke-virtual {p0, v1}, Lm61/e$a;->l(Lb51/f;)V

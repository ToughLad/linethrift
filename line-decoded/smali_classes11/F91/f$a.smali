...
# direct methods
.method public constructor <init>(Lv91/e;LDV0/m;I)V
    .locals 0

    invoke-direct {p0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, LF91/f$a;->a:Lv91/e;

    iput-object p2, p0, LF91/f$a;->c:LDV0/m;

    new-instance p1, LO91/b;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, LF91/f$a;->b:LO91/b;

    new-instance p1, Lx91/a;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LF91/f$a;->d:Lx91/a;

    iput p3, p0, LF91/f$a;->e:I
...
.method public final a(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, LF91/f$a;->c:LDV0/m;
    ...
    new-instance v0, LF91/f$a$a;

    invoke-direct {v0, p0}, LF91/f$a$a;-><init>(LF91/f$a;)V

    iget-boolean v1, p0, LF91/f$a;->g:Z

    if-nez v1, :cond_0

    iget-object p0, p0, LF91/f$a;->d:Lx91/a;
    ...
    iget-object v0, p0, LF91/f$a;->f:Ljn1/c;

    invoke-interface {v0}, Ljn1/c;->cancel()V

    invoke-virtual {p0, p1}, LF91/f$a;->onError(Ljava/lang/Throwable;)V
...
.method public final cancel()V
    ...
    iput-boolean v0, p0, LF91/f$a;->g:Z
...
.method public final h(Ljn1/c;)V
    ...
    iput-object p1, p0, LF91/f$a;->f:Ljn1/c;

    iget-object v0, p0, LF91/f$a;->a:Lv91/e;

    invoke-interface {v0, p0}, Ljn1/b;->h(Ljn1/c;)V

    const v0, 0x7fffffff

    iget p0, p0, LF91/f$a;->e:I
...
.method public final onComplete()V
    ...
    iget-object v0, p0, LF91/f$a;->b:LO91/b;

    invoke-virtual {v0}, LO91/b;->b()Ljava/lang/Throwable;

    move-result-object v0

    iget-object p0, p0, LF91/f$a;->a:Lv91/e;
    ...
    :cond_1
    iget v0, p0, LF91/f$a;->e:I

    const v1, 0x7fffffff

    if-eq v0, v1, :cond_2

    iget-object p0, p0, LF91/f$a;->f:Ljn1/c;
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, LF91/f$a;->cancel()V

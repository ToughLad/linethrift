...
# direct methods
.method public constructor <init>(Landroid/content/Context;LXl1/c;Ln11/c;Lq51/i;)V
    .locals 1
    ...
    iput-object p1, p0, Lu51/f;->a:Landroid/content/Context;

    iput-object p2, p0, Lu51/f;->b:LXl1/c;

    iput-object p3, p0, Lu51/f;->c:Ln11/c;

    iput-object p4, p0, Lu51/f;->d:Lq51/i;
    ...
    iput-object p1, p0, Lu51/f;->e:Lkotlin/Lazy;
...
# virtual methods
.method public final a(Li41/a;)Lcom/linecorp/andromeda/info/ToneInfo;
    .locals 3
    ...
    :cond_0
    instance-of v1, p1, Li41/a$b;

    if-eqz v1, :cond_1

    invoke-virtual {p1, p0}, Li41/a;->b(Landroid/content/Context;)Lcom/linecorp/andromeda/audio/tone/ToneData;

    move-result-object p0

    iput-object p0, v0, Lcom/linecorp/andromeda/info/ToneInfo;->ringbackTone:Lcom/linecorp/andromeda/audio/tone/ToneData;
...
.method public final b(Z)V
    ...
    iget-object v0, p0, Lu51/f;->a:Landroid/content/Context;

    const/4 v1, 0x0

    iget-object v2, p0, Lu51/f;->c:Ln11/c;

    if-eqz p1, :cond_1

    invoke-static {v0, v2}, Lh21/d;->a(Landroid/content/Context;Ln11/b;)V

    new-instance p1, Lu51/h;

    invoke-direct {p1, p0, v1}, Lu51/h;-><init>(Lu51/f;Lkotlin/coroutines/Continuation;)V

    iget-object v0, p0, Lu51/f;->b:LXl1/c;
    ...
    iget-object v0, p0, Lu51/f;->f:LSl1/L0;
    ...
    :cond_0
    iput-object p1, p0, Lu51/f;->f:LSl1/L0;
    ...
    :cond_4
    iget-object p1, p0, Lu51/f;->f:LSl1/L0;
    ...
    :cond_5
    iput-object v1, p0, Lu51/f;->f:LSl1/L0;

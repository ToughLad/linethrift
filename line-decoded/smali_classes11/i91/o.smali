...
.method static constructor <clinit>()V
    ...
    filled-new-array {v0}, [Lio/grpc/okhttp/internal/h;
    ...
    sput-object v0, Li91/o;->a:Ljava/util/List;
...
.method public static a(Ljavax/net/ssl/SSLSocketFactory;Ljava/net/Socket;Ljava/lang/String;ILio/grpc/okhttp/internal/b;)Ljavax/net/ssl/SSLSocket;
    ...
    invoke-static {p3, v1}, Lio/grpc/okhttp/internal/k;->a([Ljava/lang/Object;[Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    new-instance v2, Lio/grpc/okhttp/internal/b$a;

    invoke-direct {v2, p4}, Lio/grpc/okhttp/internal/b$a;-><init>(Lio/grpc/okhttp/internal/b;)V

    iget-boolean v3, v2, Lio/grpc/okhttp/internal/b$a;->a:Z

    if-eqz v3, :cond_8

    if-nez p3, :cond_1

    iput-object p1, v2, Lio/grpc/okhttp/internal/b$a;->b:[Ljava/lang/String;
    ...
    iput-object p3, v2, Lio/grpc/okhttp/internal/b$a;->b:[Ljava/lang/String;

    :goto_1
    iget-boolean p3, v2, Lio/grpc/okhttp/internal/b$a;->a:Z

    if-eqz p3, :cond_7

    if-nez v1, :cond_2

    iput-object p1, v2, Lio/grpc/okhttp/internal/b$a;->c:[Ljava/lang/String;
    ...
    iput-object p3, v2, Lio/grpc/okhttp/internal/b$a;->c:[Ljava/lang/String;

    :goto_2
    new-instance p3, Lio/grpc/okhttp/internal/b;

    invoke-direct {p3, v2}, Lio/grpc/okhttp/internal/b;-><init>(Lio/grpc/okhttp/internal/b$a;)V
    ...
    :cond_3
    sget-object p3, Li91/l;->c:Li91/l;

    iget-boolean p4, p4, Lio/grpc/okhttp/internal/b;->d:Z

    sget-object v1, Li91/o;->a:Ljava/util/List;
    ...
    :cond_4
    invoke-virtual {p3, p0, p2, p1}, Li91/l;->d(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;

    move-result-object p1

    invoke-static {p1}, Lio/grpc/okhttp/internal/h;->a(Ljava/lang/String;)Lio/grpc/okhttp/internal/h;
    ...
    invoke-static {p3, p4, p1}, LIg1/d;->u(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v0, p2}, Lbg1/p;->a(IILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p3, p4}, Lio/grpc/okhttp/internal/e;->verify(Ljava/lang/String;Ljavax/net/ssl/SSLSession;)Z
